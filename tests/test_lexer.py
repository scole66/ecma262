...
*/''', [{'type': 'PERCENT', 'value': '%'}]),
                            ...
                            ('`ab\\\u2028cd\\\u2029ef\\\ngh`', [{'type': 'NOSUBSTITUTIONTEMPLATE', 'value': ('abcdefgh', 'ab\\\u2028cd\\\u2029ef\\\ngh')}]),
                            ('`ab\ncd\u2028ef\u2029gh\rij\r\nkl`', [{'type': 'NOSUBSTITUTIONTEMPLATE', 'value': ('ab\ncd\u2028ef\u2029gh\nij\nkl', 'ab\ncd\u2028ef\u2029gh\nij\nkl')}]),
...
@pytest.mark.parametrize('test_input',
                         [ '/* unterminated', '0000', '0b1015', '0o3129', '0x', '0b', '0o', '3e', '0xab$', '0b0100r', '0o765_', '67.22e+21\u2118', '432A', '7.Z',
                           ...
                           'id_\\u005cu0040',
                           '_\\u00m', '\\u00m', '_\\u000m', '\\u000m', '_\\u{718Q', '\\u{718Q', '\\u{3a}bob', '\\u003abob', 'a\\u{3a}bob', 'a\\u003abob',
                           '\\u{47381907950801}',
...
@pytest.mark.parametrize('test_input, test_goals, expected', [
...
@pytest.mark.parametrize('test_input, test_goals', [
    ('/abcd\n', [InputElementRegExp]),
