...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("startsWith", "StringPrototype_startsWith", 1),
        ("substring", "StringPrototype_substring", 2),
        ("toLocaleLowerCase", "StringPrototype_toLocaleLowerCase", 0),
        ("toLocaleUpperCase", "StringPrototype_toLocaleUpperCase", 0),
        ("toLowerCase", "StringPrototype_toLowerCase", 0),
        ("toString", "StringPrototype_toString", 0),
        ("toUpperCase", "StringPrototype_toUpperCase", 0),
