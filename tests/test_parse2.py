...
class Test_ParseNode2:
    def test_init(self):
        pn = e.ParseNode2("my context", "my_name", ["child1", "child2"])
    ...
    def test_repr(self):
        ...
        mid_node = e.ParseNode2(None, "MidNode", [token_lower])
        top_node = e.ParseNode2(None, "TopNode", [mid_node, None, token_higher])

        r = repr(top_node)
        assert r == "ParseNode[TopNode : MidNode GENERIC] (lower higher)"

    def test_terminals(self):
        lower = e.ParseNode2(None, "lower", [IBOB, EQ, THREE, SEMICOLON])
        upper = e.ParseNode2(None, "upper", [ICHARLIE, None, LCURLY, lower, RCURLY])

        assert list(upper.terminals()) == [ICHARLIE, LCURLY, IBOB, EQ, THREE, SEMICOLON, RCURLY]

    def test_defer_target(self):
        child = e.ParseNode2(None, "child", [IBOB])
        parent = e.ParseNode2(None, "parent", [RETURN, child, SEMICOLON])

        assert parent.defer_target() == child

    @pytest.fixture
    def tree(self):
        lower = e.ParseNode2(None, "Lower", [BREAK, SEMICOLON])
        upper = e.ParseNode2(None, "Upper", [lower, FUNCTION])
        return upper
    ...
    @pytest.fixture
    def straight(self):
        bottom = e.ParseNode2(None, "Bottom", [RETURN, SEMICOLON])
        middle = e.ParseNode2(None, "Middle", [bottom])
        top = e.ParseNode2(None, "Top", [middle])
        return top
    ...
    def test_Derived_onlychild(self, derived):
        obj, _ = derived
        parent = e.ParseNode2(None, "Parent", [obj])
...
def test_P2_MemberExpression_init(context):
    me = e.P2_MemberExpression(context, ["child"])
...
def test_P2_MemberExpression_PrimaryExpression_init(context):
    me = e.P2_MemberExpression_PrimaryExpression(context, ["PrimaryExpression"])
    assert me.name == "MemberExpression"
...
def test_P2_MemberExpression_MemberExpression_LBRACKET_Expression_RBRACKET_init(context):
    me = e.P2_MemberExpression_MemberExpression_LBRACKET_Expression_RBRACKET(
        context, ["MemberExpression", "[", "Expression", "]"]
    )
    assert me.name == "MemberExpression"
...
def test_P2_MemberExpression_MemberExpression_PERIOD_IdentifierName_init(context):
    me = e.P2_MemberExpression_MemberExpression_PERIOD_IdentifierName(
        context, ["MemberExpression_alpha", ".", "IdentifierName_beta"]
    )
    assert me.name == "MemberExpression"
...
def test_P2_MemberExpression_MemberExpression_TemplateLiteral_init(context):
    me = e.P2_MemberExpression_MemberExpression_TemplateLiteral(
        context, ["MemberExpression_alpha", "TemplateLiteral_beta"]
    )
    assert me.name == "MemberExpression"
    assert me.MemberExpression == "MemberExpression_alpha"
...
def test_P2_MemberExpression_SuperProperty_init(context):
    me = e.P2_MemberExpression_SuperProperty(context, ["SuperProp"])
    assert me.name == "MemberExpression"
    assert me.SuperProperty == "SuperProp"


def test_P2_MemberExpression_MetaProperty_init(context):
    me = e.P2_MemberExpression_MetaProperty(context, ["MetaProp"])
    assert me.name == "MemberExpression"
    assert me.MetaProperty == "MetaProp"


def test_P2_MemberExpression_NEW_MemberExpression_Arguments_init(context):
    me = e.P2_MemberExpression_NEW_MemberExpression_Arguments(context, ["new", "ME_alpha", "args"])
    assert me.name == "MemberExpression"
...
def test_parse_MemberExpression_01(mocker, context):
    ...
    me = e.parse_MemberExpression(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_MemberExpression_02(mocker, context):
    ...
    parse_EXP.assert_called_with(context, lexer, True, "YieldArg", "AwaitArg")
    assert me.Expression == "Expression"
...
def test_parse_MemberExpression_04(mocker, context):
    ...
    tl_mock.assert_called_with(context, lexer, "YieldArg", "AwaitArg", True)
    me2 = me.MemberExpression
    assert isinstance(me2, e.P2_MemberExpression_PrimaryExpression)
    assert me2.PrimaryExpression == "PrimaryExpression"
    assert lexer.pos == 2
...
def test_parse_MemberExpression_05(mocker, context):
    ...
    superprop.assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    assert lexer.pos == 1
...
def test_parse_MemberExpression_06(mocker, context):
    ...
    metaprop.assert_called_with(context, lexer)
    assert lexer.pos == 1
...
def test_parse_MemberExpression_07(mocker, context):
    ...
    argsmock.assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    me2 = me.MemberExpression
    assert isinstance(me2, e.P2_MemberExpression_PrimaryExpression)
    assert me2.PrimaryExpression == "PrimaryExpression"
    assert lexer.pos == 3
...
def test_P2_SuperProperty_init(context):
    sp = e.P2_SuperProperty(context, ["child"])
...
def test_P2_SuperProperty_SUPER_LBRACKET_Expression_RBRACKET_init(context):
    sp = e.P2_SuperProperty_SUPER_LBRACKET_Expression_RBRACKET(context, ["super", "[", "Expression", "]"])
    assert sp.name == "SuperProperty"
    assert sp.Expression == "Expression"


def test_P2_SuperProperty_SUPER_PERIOD_IdentifierName_init(context):
    sp = e.P2_SuperProperty_SUPER_PERIOD_IdentifierName(context, ["super", ".", "IdentifierName"])
    assert sp.name == "SuperProperty"
...
def test_parse_SuperProperty_01(mocker, context):
    ...
    sp = e.parse_SuperProperty(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(sp, e.P2_SuperProperty_SUPER_LBRACKET_Expression_RBRACKET)
    assert sp.Expression == "Expression"
    mock_exp.assert_called_with(context, lexer, True, "YieldArg", "AwaitArg")
    assert lexer.pos == 4
...
def test_P2_MetaProperty_init(context):
    mp = e.P2_MetaProperty(context, ["child"])
...
def test_P2_MetaProperty_NewTarget_init(context):
    mp = e.P2_MetaProperty_NewTarget(context, ["NewTarget"])
    assert mp.name == "MetaProperty"
...
def test_parse_MetaProperty_01(mocker, context):
    ...
    mp = e.parse_MetaProperty(context, lexer)
    assert isinstance(mp, e.P2_MetaProperty_NewTarget)
    assert mp.NewTarget == "NewTarget"
    nt_mock.assert_called_with(context, lexer)
    assert lexer.pos == 1
...
def test_P2_NewTarget_init(context):
    sp = e.P2_NewTarget(context, ["child"])
...
def test_P2_NewTarget_NEW_PERIOD_TARGET_init(context):
    sp = e.P2_NewTarget_NEW_PERIOD_TARGET(context, ["new", ".", "target"])
    assert sp.name == "NewTarget"
...
def test_parse_NewTarget_01(context):
    ...
    nt = e.parse_NewTarget(context, lexer)
...
def test_P2_NewExpression_init(context):
    ne = e.P2_NewExpression(context, ["child"])
...
def test_P2_NewExpression_MemberExpression_init(context):
    ne = e.P2_NewExpression_MemberExpression(context, ["MemberExpression"])
    assert ne.name == "NewExpression"
    assert ne.MemberExpression == "MemberExpression"


def test_P2_NewExpression_NEW_NewExpression_init(context):
    ne = e.P2_NewExpression_NEW_NewExpression(context, ["new", "NewExpression"])
    assert ne.name == "NewExpression"
...
def test_parse_NewExpression_01(mocker, context):
    ...
    ne = e.parse_NewExpression(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(ne, e.P2_NewExpression_MemberExpression)
    assert ne.MemberExpression == "MemberExpression"
    assert lexer.pos == 1
    me_mock.assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_CallExpression_init(context):
    ce = e.P2_CallExpression(context, ["child"])
...
def test_P2_CallExpression_CoverCallExpressionAndAsyncArrowHead_init(context):
    ce = e.P2_CallExpression_CoverCallExpressionAndAsyncArrowHead(
        context, ["CoverCallExpressionAndAsyncArrowHead"], "YieldArg", "AwaitArg"
    )
    assert ce.name == "CallExpression"
...
def test_P2_CallExpression_SuperCall_init(context):
    ce = e.P2_CallExpression_SuperCall(context, ["SuperCall"])
    assert ce.name == "CallExpression"
    assert ce.SuperCall == "SuperCall"


def test_P2_CallExpression_CallExpression_Arguments_init(context):
    ce = e.P2_CallExpression_CallExpression_Arguments(context, ["CallExpression", "Arguments"])
    assert ce.name == "CallExpression"
...
def test_P2_CallExpression_CallExpression_LBRACKET_Expression_RBRACKET_init(context):
    ce = e.P2_CallExpression_CallExpression_LBRACKET_Expression_RBRACKET(
        context, ["CallExpression", "[", "Expression", "]"]
    )
    assert ce.name == "CallExpression"
    assert ce.CallExpression == "CallExpression"
...
def test_P2_CallExpression_CallExpression_PERIOD_IdentifierName_init(context):
    ce = e.P2_CallExpression_CallExpression_PERIOD_IdentifierName(context, ["CallExpression", ".", "IdentifierName"])
    assert ce.name == "CallExpression"
    assert ce.CallExpression == "CallExpression"
...
def test_P2_CallExpression_CallExpression_TemplateLiteral_init(context):
    ce = e.P2_CallExpression_CallExpression_TemplateLiteral(context, ["CallExpression", "TemplateLiteral"])
    assert ce.name == "CallExpression"
    assert ce.CallExpression == "CallExpression"
...
def test_parse_CallExpression_01(mocker, context):
    ...
    ce = e.parse_CallExpression(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(ce, e.P2_CallExpression_CoverCallExpressionAndAsyncArrowHead)
    assert ce.CoverCallExpressionAndAsyncArrowHead == "CoverCallExpressionAndAsyncArrowHead"
    assert lexer.pos == 1
    mocks["cce"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_CallExpression_02(mocker, context):
    ...
    assert ce.SuperCall == "SuperCall"
    assert lexer.pos == 1
    mocks["sc"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_CallExpression_03(mocker, context):
    ...
    mocks["args"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    assert lexer.pos == 2
...
def test_parse_CallExpression_06(mocker, context):
    ...
    assert ce.TemplateLiteral == "TemplateLiteral"
    mocks["tl"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", True)
    ce2 = ce.CallExpression
    assert isinstance(ce2, e.P2_CallExpression_CoverCallExpressionAndAsyncArrowHead)
    assert ce2.CoverCallExpressionAndAsyncArrowHead == "CoverCallExpressionAndAsyncArrowHead"
    assert lexer.pos == 2
...
def test_P2_SuperCall_init(context):
    sc = e.P2_SuperCall(context, ["child"])
...
def test_P2_SueprCall_SUPER_Arguments_init(context):
    sc = e.P2_SuperCall_SUPER_Arguments(context, ["super", "Arguments"])
    assert sc.name == "SuperCall"
...
def test_parse_SuperCall_01(mocker, context):
    ...
    sc = e.parse_SuperCall(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_Arguments_init(context):
    args = e.P2_Arguments(context, ["child"])
...
def test_P2_Arguments_LPAREN_RPAREN_init(context):
    args = e.P2_Arguments_LPAREN_RPAREN(context, ["(", ")"])
    assert args.name == "Arguments"


def test_P2_Arguments_LPAREN_ArgumentList_RPAREN_init(context):
    args = e.P2_Arguments_LPAREN_ArgumentList_RPAREN(context, ["(", "ArgumentList", ")"])
    assert args.name == "Arguments"
    assert args.ArgumentList == "ArgumentList"


def test_P2_Arguments_LPAREN_ArgumentList_COMMA_RPAREN_init(context):
    args = e.P2_Arguments_LPAREN_ArgumentList_COMMA_RPAREN(context, ["(", "ArgumentList", ",", ")"])
    assert args.name == "Arguments"
    assert args.ArgumentList == "ArgumentList"
...
def test_parse_Arguments_01(mocker, context):
    ...
    args = e.parse_Arguments(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Arguments_02(mocker, context):
    ...
    assert args.ArgumentList == "ArgumentList"
    mocks["al"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    assert lexer.pos == 3
...
def test_P2_ArgumentList_init(context):
    al = e.P2_ArgumentList(context, ["child"])
...
def test_P2_ArgumentList_AssignmentExpression_init(context):
    al = e.P2_ArgumentList_AssignmentExpression(context, ["AssignmentExpression"])
    assert al.name == "ArgumentList"
    assert al.AssignmentExpression == "AssignmentExpression"


def test_P2_ArgumentList_DOTDOTDOT_AssignmentExpression_init(context):
    al = e.P2_ArgumentList_DOTDOTDOT_AssignmentExpression(context, ["...", "AssignmentExpression"])
    assert al.name == "ArgumentList"
    assert al.AssignmentExpression == "AssignmentExpression"
...
def test_P2_ArgumentList_ArgumentList_COMMA_AssignmentExpression_init(context):
    al = e.P2_ArgumentList_ArgumentList_COMMA_AssignmentExpression(
        context, ["ArgumentList", ",", "AssignmentExpression"]
    )
    assert al.name == "ArgumentList"
...
def test_parse_ArgumentList_01(mocker, context):
    ...
    al = e.parse_ArgumentList(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_LeftHandSideExpression_init(context):
    lhs = e.P2_LeftHandSideExpression(context, ["child"], "YieldArg", "AwaitArg")
...
def test_P2_LeftHandSideExpression_NewExpression_init(context):
    lhs = e.P2_LeftHandSideExpression_NewExpression(context, ["NewExpression"], "YieldArg", "AwaitArg")
    assert lhs.name == "LeftHandSideExpression"
    assert lhs.NewExpression == "NewExpression"


def test_P2_LeftHandSideExpression_CallExpression_init(context):
    lhs = e.P2_LeftHandSideExpression_CallExpression(context, ["CallExpression"], "YieldArg", "AwaitArg")
    assert lhs.name == "LeftHandSideExpression"
...
def test_parse_LeftHandSideExpression_01(mocker, context):
    ...
    lhs = e.parse_LeftHandSideExpression(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(lhs, e.P2_LeftHandSideExpression_NewExpression)
    assert lhs.NewExpression == "NewExpression"
    assert lexer.pos == 1
    mocks["ne"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_LeftHandSideExpression_02(mocker, context):
    ...
    assert lhs.CallExpression == "CallExpression"
    assert lexer.pos == 1
    mocks["ce"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_CallMemberExpression_init(context):
    cme = e.P2_CallMemberExpression(context, ["child"])
...
def test_P2_CallMemberExpression_MemberExpression_Arguments_init(context):
    cme = e.P2_CallMemberExpression_MemberExpression_Arguments(context, ["MemberExpression", "Arguments"])
    assert cme.name == "CallMemberExpression"
...
def test_parse_CallMemberExpression_01(mocker, context):
    ...
    cme = e.parse_CallMemberExpression(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(cme, e.P2_CallMemberExpression_MemberExpression_Arguments)
    assert cme.MemberExpression == "MemberExpression"
    assert cme.Arguments == "Arguments"
    assert lexer.pos == 2
    mocks["me"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    mocks["args"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_UpdateExpression_init(context):
    upe = e.P2_UpdateExpression(context, ["child"])
...
def test_parse_UpdateExpression_01(mocker, context):
    ...
    upe = e.parse_UpdateExpression(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["lhs"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_UpdateExpression_03(mocker, context, token_stream, expected_class):
    ...
    assert lexer.pos == 2
    mocks["une"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_UnaryExpression_init(context):
    une = e.P2_UnaryExpression(context, ["child"])
...
def test_P2_UnaryExpression_UpdateExpression_init(context):
    une = e.P2_UnaryExpression_UpdateExpression(context, ["Update"])
    assert une.name == "UnaryExpression"
    assert une.UpdateExpression == "Update"


def test_P2_UnaryExpression_DELETE_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_DELETE_UnaryExpression(context, ["delete", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_VOID_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_VOID_UnaryExpression(context, ["void", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_TYPEOF_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_TYPEOF_UnaryExpression(context, ["typeof", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_PLUS_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_PLUS_UnaryExpression(context, ["+", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_MINUS_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_MINUS_UnaryExpression(context, ["-", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_TILDE_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_TILDE_UnaryExpression(context, ["~", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_BANG_UnaryExpression_init(context):
    une = e.P2_UnaryExpression_BANG_UnaryExpression(context, ["!", "Unary"])
    assert une.name == "UnaryExpression"
    assert une.UnaryExpression == "Unary"


def test_P2_UnaryExpression_AwaitExpression_init(context):
    une = e.P2_UnaryExpression_AwaitExpression(context, ["AwaitExpression"])
    assert une.name == "UnaryExpression"
...
def test_parse_UnaryExpression_01(mocker, context, Await):
    ...
    une = e.parse_UnaryExpression(context, lexer, "YieldArg", Await)
    assert isinstance(une, e.P2_UnaryExpression_UpdateExpression)
    assert une.UpdateExpression == "UpdateExpression"
    assert lexer.pos == 1
    mocks["upe"].assert_called_with(context, lexer, "YieldArg", Await)
...
def test_parse_UnaryExpression_03(mocker, context):
    ...
    une = e.parse_UnaryExpression(context, lexer, "YieldArg", True)
    assert isinstance(une, e.P2_UnaryExpression_AwaitExpression)
    assert une.AwaitExpression == "AwaitExpression"
    assert lexer.pos == 1
    mocks["awe"].assert_called_with(context, lexer, "YieldArg")
...
def test_parse_UnaryExpression_04(mocker, context):
    ...
    une = e.parse_UnaryExpression(context, lexer, "YieldArg", False)
    assert une is None
    assert lexer.pos == 0
...
def test_P2_ExponentiationExpression_init(context):
    ee = e.P2_ExponentiationExpression(context, ["child"])
...
def test_P2_ExponentiationExpression_UnaryExpression_init(context):
    ee = e.P2_ExponentiationExpression_UnaryExpression(context, ["child"])
    assert ee.name == "ExponentiationExpression"
...
def test_P2_ExponentiationExpression_UpdateExpression_STARSTAR_ExponentiationExpression_init(context):
    ee = e.P2_ExponentiationExpression_UpdateExpression_STARSTAR_ExponentiationExpression(context, ["upe", "**", "ee"])
    assert ee.name == "ExponentiationExpression"
...
def test_parse_ExponentiationExpression_UnaryExpression(mocker, context):
    ...
    ee = e.parse_ExponentiationExpression(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_ExponentiationExpression_STARSTAR(mocker, context):
    ...
    mocks["upe"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_MultiplicativeExpression_init(context):
    me = e.P2_MultiplicativeExpression(context, ["child"])
...
def test_P2_MultiplicativeExpression_ExponentiationExpression_init(context):
    me = e.P2_MultiplicativeExpression_ExponentiationExpression(context, ["child"])
    assert me.name == "MultiplicativeExpression"
...
def test_parse_MultiplicativeExpression_01(mocker, context):
    ...
    me = e.parse_MultiplicativeExpression(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["ee"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_MultiplicativeExpression_02(mocker, context):
    ...
    assert lexer.pos == 3
    mocks["mo"].assert_called_with(context, lexer)
    mocks["ee"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_MultiplicativeOperator_init(context):
    mo = e.P2_MultiplicativeOperator(context, ["child"])
...
def test_P2_MultiplicativeOperator_MULT_init(context):
    mo = e.P2_MultiplicativeOperator_MULT(context, ["child"])
    assert mo.name == "MultiplicativeOperator"


def test_P2_MultiplicativeOperator_DIV_init(context):
    mo = e.P2_MultiplicativeOperator_DIV(context, ["child"])
    assert mo.name == "MultiplicativeOperator"


def test_P2_MultiplicativeOperator_MOD_init(context):
    mo = e.P2_MultiplicativeOperator_MOD(context, ["child"])
    assert mo.name == "MultiplicativeOperator"
...
def test_parse_MultiplicativeOperator_01(context, token_stream, expected_class):
    ...
    mo = e.parse_MultiplicativeOperator(context, lexer)
...
def test_P2_AdditiveExpression_init(context):
    ae = e.P2_AdditiveExpression(context, ["child"])
...
def test_P2_AdditiveExpression_MultiplicativeExpression_init(context):
    ae = e.P2_AdditiveExpression_MultiplicativeExpression(context, ["child"])
    assert ae.name == "AdditiveExpression"
...
def test_P2_AdditiveExpression_AdditiveExpression_PLUS_MultiplicativeExpression_init(context):
    ae = e.P2_AdditiveExpression_AdditiveExpression_PLUS_MultiplicativeExpression(context, ["child", "+", "alice"])
    assert ae.name == "AdditiveExpression"
...
def test_P2_AdditiveExpression_AdditiveExpression_MINUS_MultiplicativeExpression_init(context):
    ae = e.P2_AdditiveExpression_AdditiveExpression_MINUS_MultiplicativeExpression(context, ["child", "-", "alice"])
    assert ae.name == "AdditiveExpression"
    assert ae.AdditiveExpression == "child"
    assert ae.MultiplicativeExpression == "alice"
...
def test_parse_AdditiveExpression_01(mocker, context):
    ...
    ae = e.parse_AdditiveExpression(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["mult"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_ShiftExpression_init(context):
    se = e.P2_ShiftExpression(context, ["child"])
...
def test_P2_ShiftExpression_AdditiveExpression_init(context):
    se = e.P2_ShiftExpression_AdditiveExpression(context, ["child"])
    assert se.name == "ShiftExpression"
    assert se.AdditiveExpression == "child"


def test_P2_ShiftExpression_ShiftExpression_LTLT_AdditiveExpression_init(context):
    se = e.P2_ShiftExpression_ShiftExpression_LTLT_AdditiveExpression(context, ["ShiExp", "<<", "AddExp"])
    assert se.name == "ShiftExpression"
...
def test_P2_ShiftExpression_ShiftExpression_GTGT_AdditiveExpression_init(context):
    se = e.P2_ShiftExpression_ShiftExpression_GTGT_AdditiveExpression(context, ["ShiExp", ">>", "AddExp"])
    assert se.name == "ShiftExpression"
    assert se.ShiftExpression == "ShiExp"
    assert se.AdditiveExpression == "AddExp"
...
def test_P2_ShiftExpression_ShiftExpression_GTGTGT_AdditiveExpression_init(context):
    se = e.P2_ShiftExpression_ShiftExpression_GTGTGT_AdditiveExpression(context, ["ShiExp", ">>>", "AddExp"])
    assert se.name == "ShiftExpression"
    assert se.ShiftExpression == "ShiExp"
    assert se.AdditiveExpression == "AddExp"
...
def test_parse_ShiftExpression_01(mocker, context):
    ...
    se = e.parse_ShiftExpression(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(se, e.P2_ShiftExpression_AdditiveExpression)
    assert se.AdditiveExpression == "AdditiveExpression"
    assert lexer.pos == 1
    mocks["AdditiveExpression"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_RelationalExpression(context):
    re = e.P2_RelationalExpression(context, ["child"])
...
def test_P2_RelationalExpression_ShiftExpression(context):
    re = e.P2_RelationalExpression_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"
    assert re.ShiftExpression == "child"


def test_P2_RelationalExpression_RelationalExpression_OP_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_OP_ShiftExpression(context, ["left", "<", "right"])
    assert re.name == "RelationalExpression"
...
def test_P2_RelationalExpression_RelationalExpression_LT_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_LT_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"


def test_P2_RelationalExpression_RelationalExpression_GT_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_GT_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"


def test_P2_RelationalExpression_RelationalExpression_LE_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_LE_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"


def test_P2_RelationalExpression_RelationalExpression_GE_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_GE_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"


def test_P2_RelationalExpression_RelationalExpression_INSTANCEOF_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_INSTANCEOF_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"


def test_P2_RelationalExpression_RelationalExpression_IN_ShiftExpression(context):
    re = e.P2_RelationalExpression_RelationalExpression_IN_ShiftExpression(context, ["child"])
    assert re.name == "RelationalExpression"
...
def test_parse_RelationalExpression_01(mocker, context, In):
    ...
    re = e.parse_RelationalExpression(context, lexer, In, "YieldArg", "AwaitArg")
    assert isinstance(re, e.P2_RelationalExpression_ShiftExpression)
    assert re.ShiftExpression == "ShiftExpression"
    assert lexer.pos == 1
    mocks["ShiftExpression"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_RelationalExpression_03(mocker, context):
    ...
    re = e.parse_RelationalExpression(context, lexer, False, "YieldArg", "AwaitArg")
    assert isinstance(re, e.P2_RelationalExpression_ShiftExpression)
    assert lexer.pos == 1
...
def test_parse_RelationalExpression_04(mocker, context):
    ...
    re = e.parse_RelationalExpression(context, lexer, True, "YieldArg", "AwaitArg")
...
def test_P2_EqualityExpression_init(context):
    ee = e.P2_EqualityExpression(context, ["child"])
...
def test_P2_EqualityExpression_RelationalExpression_init(context):
    ee = e.P2_EqualityExpression_RelationalExpression(context, ["child"])
    assert ee.name == "EqualityExpression"
...
def test_P2_EqualityExpression_EqualityExpression_OP_RelationalExpression_init(context):
    ee = e.P2_EqualityExpression_EqualityExpression_OP_RelationalExpression(context, ["child", "==", "vampire"])
    assert ee.name == "EqualityExpression"
...
def test_P2_EqualityExpression_EqualityExpression_EQEQ_RelationalExpression_init(context):
    ee = e.P2_EqualityExpression_EqualityExpression_EQEQ_RelationalExpression(context, ["child"])
    assert ee.name == "EqualityExpression"


def test_P2_EqualityExpression_EqualityExpression_BANGEQ_RelationalExpression_init(context):
    ee = e.P2_EqualityExpression_EqualityExpression_BANGEQ_RelationalExpression(context, ["child"])
    assert ee.name == "EqualityExpression"


def test_P2_EqualityExpression_EqualityExpression_EQEQEQ_RelationalExpression_init(context):
    ee = e.P2_EqualityExpression_EqualityExpression_EQEQEQ_RelationalExpression(context, ["child"])
    assert ee.name == "EqualityExpression"


def test_P2_EqualityExpression_EqualityExpression_BANGEQEQ_RelationalExpression_init(context):
    ee = e.P2_EqualityExpression_EqualityExpression_BANGEQEQ_RelationalExpression(context, ["child"])
    assert ee.name == "EqualityExpression"
...
def test_parse_EqualityExpression_01(mocker, context):
    ...
    ee = e.parse_EqualityExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(ee, e.P2_EqualityExpression_RelationalExpression)
    assert ee.RelationalExpression == "RelationalExpression"
    assert lexer.pos == 1
    mocks["RelationalExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_BitwiseANDExpression_init(context):
    bae = e.P2_BitwiseANDExpression(context, ["child"])
...
def test_P2_BitwiseANDExpression_EqualityExpression_init(context):
    bae = e.P2_BitwiseANDExpression_EqualityExpression(context, ["child"])
    assert bae.name == "BitwiseANDExpression"
...
def test_P2_BitwiseANDExpression_BitwiseANDExpression_AMP_EqualityExpression_init(context):
    bae = e.P2_BitwiseANDExpression_BitwiseANDExpression_AMP_EqualityExpression(context, ["child", "&", "right"])
    assert bae.name == "BitwiseANDExpression"
...
def test_parse_BitwiseANDExpression_01(mocker, context):
    ...
    bae = e.parse_BitwiseANDExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(bae, e.P2_BitwiseANDExpression_EqualityExpression)
    assert bae.EqualityExpression == "EqualityExpression"
    assert lexer.pos == 1
    mocks["EqualityExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_BitwiseXORExpression_init(context):
    bxe = e.P2_BitwiseXORExpression(context, ["child"])
...
def test_P2_BitwiseXORExpression_BitwiseANDExpression_init(context):
    bxe = e.P2_BitwiseXORExpression_BitwiseANDExpression(context, ["child"])
    assert bxe.name == "BitwiseXORExpression"
...
def test_P2_BitwiseXORExpression_BitwiseXORExpression_CARET_BitwiseANDExpression_init(context):
    bxe = e.P2_BitwiseXORExpression_BitwiseXORExpression_CARET_BitwiseANDExpression(context, ["child", "^", "0x10"])
    assert bxe.name == "BitwiseXORExpression"
...
def test_parse_BitwiseXORExpression_01(mocker, context):
    ...
    bxe = e.parse_BitwiseXORExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(bxe, e.P2_BitwiseXORExpression_BitwiseANDExpression)
    assert bxe.BitwiseANDExpression == "BitwiseANDExpression"
    assert lexer.pos == 1
    mocks["BitwiseANDExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_BitwiseORExpression_init(context):
    boe = e.P2_BitwiseORExpression(context, ["child"])
...
def test_P2_BitwiseORExpression_BitwiseXORExpression_init(context):
    boe = e.P2_BitwiseORExpression_BitwiseXORExpression(context, ["child"])
    assert boe.name == "BitwiseORExpression"
...
def test_P2_BitwiseORExpression_BitwiseORExpression_PIPE_BitwiseXORExpression_init(context):
    boe = e.P2_BitwiseORExpression_BitwiseORExpression_PIPE_BitwiseXORExpression(context, ["child", "|", "bxe"])
    assert boe.name == "BitwiseORExpression"
...
def test_parse_BitwiseORExpression_01(mocker, context):
    ...
    boe = e.parse_BitwiseORExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(boe, e.P2_BitwiseORExpression_BitwiseXORExpression)
    assert boe.BitwiseXORExpression == "BitwiseXORExpression"
    assert lexer.pos == 1
    mocks["BitwiseXORExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_LogicalANDExpression_init(context):
    lae = e.P2_LogicalANDExpression(context, ["child"])
...
def test_P2_LogicalANDExpression_BitwiseORExpression_init(context):
    lae = e.P2_LogicalANDExpression_BitwiseORExpression(context, ["child"])
    assert lae.name == "LogicalANDExpression"
...
def test_P2_LogicalANDExpression_LogicalANDExpression_AMPAMP_BitwiseORExpression_init(context):
    lae = e.P2_LogicalANDExpression_LogicalANDExpression_AMPAMP_BitwiseORExpression(context, ["child", "&&", "lemon"])
    assert lae.name == "LogicalANDExpression"
...
def test_parse_LogicalANDExpression_01(mocker, context):
    ...
    lae = e.parse_LogicalANDExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(lae, e.P2_LogicalANDExpression_BitwiseORExpression)
    assert lae.BitwiseORExpression == "BitwiseORExpression"
    assert lexer.pos == 1
    mocks["BitwiseORExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_LogicalORExpression_init(context):
    loe = e.P2_LogicalORExpression(context, ["child"])
...
def test_P2_LogicalORExpression_LogicalANDExpression_init(context):
    loe = e.P2_LogicalORExpression_LogicalANDExpression(context, ["child"])
    assert loe.name == "LogicalORExpression"
...
def test_P2_LogicalORExpression_LogicalORExpression_PIPEPIPE_LogicalANDExpression_init(context):
    loe = e.P2_LogicalORExpression_LogicalORExpression_PIPEPIPE_LogicalANDExpression(context, ["child", "||", "right"])
    assert loe.name == "LogicalORExpression"
...
def test_parse_LogicalORExpression_01(mocker, context):
    ...
    loe = e.parse_LogicalORExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(loe, e.P2_LogicalORExpression_LogicalANDExpression)
    assert loe.LogicalANDExpression == "LogicalANDExpression"
    assert lexer.pos == 1
    mocks["LogicalANDExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_ConditionalExpression_init(context):
    ce = e.P2_ConditionalExpression(context, ["child"])
...
def test_P2_ConditionalExpression_LogicalORExpression_init(context):
    ce = e.P2_ConditionalExpression_LogicalORExpression(context, ["child"])
    assert ce.name == "ConditionalExpression"
...
def test_parse_ConditionalExpression_01(mocker, context):
    ...
    ce = e.parse_ConditionalExpression(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(ce, e.P2_ConditionalExpression_LogicalORExpression)
    assert ce.LogicalORExpression == "LogicalORExpression"
    assert lexer.pos == 1
    mocks["LogicalORExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_parse_ConditionalExpression_02(mocker, context):
    ...
    mocks["LogicalORExpression"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
    ae_expected_calls = [
        mocker.call(context, lexer, True, "YieldArg", "AwaitArg"),
        mocker.call(context, lexer, "InArg", "YieldArg", "AwaitArg"),
    ]
...
def test_P2_AssignmentExpression_init(context):
    ae = e.P2_AssignmentExpression(context, ["child"])
...
def test_P2_AssignmentExpression_LeftHandSideExpression_EQ_AssignmentExpression_init(context):
    ae = e.P2_AssignmentExpression_LeftHandSideExpression_EQ_AssignmentExpression(context, ["child", "=", "right"])
    assert ae.name == "AssignmentExpression"
...
def test_parse_AssignmentExpression_CE(mocker, context, Yield):
    ...
    ae = e.parse_AssignmentExpression(context, lexer, "InArg", Yield, "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["ConditionalExpression"].assert_called_with(context, lexer, "InArg", Yield, "AwaitArg")
...
def test_parse_AssignmentExpression_YE_Nope(mocker, context):
    ...
    ae = e.parse_AssignmentExpression(context, lexer, "InArg", False, "AwaitArg")
    assert ae is None
    assert lexer.pos == 0
...
def test_parse_AssignmentExpression_YE_Yep(mocker, context):
    ...
    ae = e.parse_AssignmentExpression(context, lexer, "InArg", True, "AwaitArg")
    assert isinstance(ae, e.P2_AssignmentExpression_YieldExpression)
    assert ae.YieldExpression == "YieldExpression"
    assert lexer.pos == 1
    mocks["YieldExpression"].assert_called_with(context, lexer, "InArg", "AwaitArg")
...
def test_parse_AssignmentExpression_AF(mocker, context, Yield):
    ...
    assert lexer.pos == 1
    mocks["ArrowFunction"].assert_called_with(context, lexer, "InArg", Yield, "AwaitArg")
...
def test_parse_AssignmentExpression_AAF(mocker, context, Yield):
    ...
    assert lexer.pos == 1
    mocks["AsyncArrowFunction"].assert_called_with(context, lexer, "InArg", Yield, "AwaitArg")
...
def test_parse_AssignmentExpression_LHSEQ(mocker, context, Yield):
    ...
    assert lexer.pos == 3
    mocks["LeftHandSideExpression"].assert_called_with(context, lexer, Yield, "AwaitArg")
...
def test_P2_AssignmentPattern_init(context):
    ap = e.P2_AssignmentPattern(context, ["child"])
...
def test_P2_AssignmentPattern_ObjectAssignmentPattern_init(context):
    ap = e.P2_AssignmentPattern_ObjectAssignmentPattern(context, ["child"])
    assert ap.name == "AssignmentPattern"
    assert ap.ObjectAssignmentPattern == "child"


def test_P2_AssignmentPattern_ArrayAssignmentPattern_init(context):
    ap = e.P2_AssignmentPattern_ArrayAssignmentPattern(context, ["child"])
    assert ap.name == "AssignmentPattern"
...
def test_parse_AssignmentPattern_obj(mocker, context):
    ...
    ap = e.parse_AssignmentPattern(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["ObjectAssignmentPattern"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_AssignmentPattern_array(mocker, context):
    ...
    assert lexer.pos == 1
    mocks["ArrayAssignmentPattern"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_ObjectAssignmentPattern_init(context):
    oap = e.P2_ObjectAssignmentPattern(context, ["child"])
...
def test_P2_ObjectAssignmentPattern_Empty_init(context):
    oap = e.P2_ObjectAssignmentPattern_Empty(context, ["{", "}"])
    assert oap.name == "ObjectAssignmentPattern"


def test_P2_ObjectAssignmentPattern_AssignmentRestProperty_init(context):
    oap = e.P2_ObjectAssignmentPattern_AssignmentRestProperty(context, ["{", "child", "}"])
    assert oap.name == "ObjectAssignmentPattern"
    assert oap.AssignmentRestProperty == "child"


def test_P2_ObjectAssignmentPattern_AssignmentPropertyList_init(context):
    oap = e.P2_ObjectAssignmentPattern_AssignmentPropertyList(context, ["{", "child", "}"])
    assert oap.name == "ObjectAssignmentPattern"
...
def test_parse_ObjectAssignmentPattern_empty(mocker, context):
    ...
    oap = e.parse_ObjectAssignmentPattern(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_ObjectAssignmentPattern_arp(mocker, context):
    ...
    assert lexer.pos == 3
    mocks["AssignmentRestProperty"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_ObjectAssignmentPattern_apl(mocker, context, token_stream):
    ...
    mocks["AssignmentPropertyList"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_ArrayAssignmentPattern_init(context):
    aap = e.P2_ArrayAssignmentPattern(context, ["child"])
...
def test_P2_ArrayAssignmentPattern_Empty_init(context):
    aap = e.P2_ArrayAssignmentPattern_Empty(context, ["[", "]"])
    assert aap.name == "ArrayAssignmentPattern"
    assert aap.Elision is None
    assert aap.AssignmentRestElement is None
    assert aap.AssignmentElementList is None
...
def test_P2_ArrayAssignmentPattern_AssignmentRestElement_init(context):
    aap = e.P2_ArrayAssignmentPattern_AssignmentRestElement(context, ["[", "ARE", "]"])
    assert aap.name == "ArrayAssignmentPattern"
    assert aap.Elision is None
...
def test_P2_ArrayAssignmentPattern_Elision_init(context):
    aap = e.P2_ArrayAssignmentPattern_Elision(context, ["[", "ELISION", "]"])
    assert aap.name == "ArrayAssignmentPattern"
...
def test_P2_ArrayAssignmentPattern_Elision_AssignmentRestElement_init(context):
    aap = e.P2_ArrayAssignmentPattern_Elision_AssignmentRestElement(context, ["[", "ELISION", "ARE", "]"])
    assert aap.name == "ArrayAssignmentPattern"
    assert aap.Elision == "ELISION"
    assert aap.AssignmentRestElement == "ARE"
    assert aap.AssignmentElementList is None
...
def test_P2_ArrayAssignmentPattern_AssignmentElementList_init(context):
    aap = e.P2_ArrayAssignmentPattern_AssignmentElementList(context, ["[", "AEL", "]"])
    assert aap.name == "ArrayAssignmentPattern"
    assert aap.Elision is None
    assert aap.AssignmentRestElement is None
...
def test_P2_ArrayAssignmentPattern_AssignmentElementList_Elision_init(context):
    aap = e.P2_ArrayAssignmentPattern_AssignmentElementList_Elision(context, ["[", "AEL", ",", "ELISION", "]"])
    assert aap.name == "ArrayAssignmentPattern"
    assert aap.Elision == "ELISION"
    assert aap.AssignmentRestElement is None
    assert aap.AssignmentElementList == "AEL"
...
def test_parse_ArrayAssignmentPattern_01(mocker, context, token_stream, expected_class, has_elision, has_are, has_ael):
    ...
    elision_mock_check = mock_check("Elision", has_elision)
    are_mock_check = mock_check("AssignmentRestElement", has_are, "YieldArg", "AwaitArg")
    ael_mock_check = mock_check("AssignmentElementList", has_ael, "YieldArg", "AwaitArg")

    aap = e.parse_ArrayAssignmentPattern(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentRestProperty_init(context):
    arp = e.P2_AssignmentRestProperty(context, ["child"])
...
def test_P2_AssignmentRestProperty_DestructuringAssignmentTarget_init(context):
    arp = e.P2_AssignmentRestProperty_DestructuringAssignmentTarget(context, ["...", "DAT"])
    assert arp.name == "AssignmentRestProperty"
...
def test_parse_AssignmentRestProperty_01(mocker, context):
    ...
    arp = e.parse_AssignmentRestProperty(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 2
    mocks["DestructuringAssignmentTarget"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentPropertyList_init(context):
    apl = e.P2_AssignmentPropertyList(context, ["child"])
...
def test_P2_AssignmentPropertyList_AssignmentProperty_init(context):
    apl = e.P2_AssignmentPropertyList_AssignmentProperty(context, ["child"])
    assert apl.name == "AssignmentPropertyList"
...
def test_P2_AssignmentPropertyList_AssignmentPropertyList_AssignmentProperty_init(context):
    apl = e.P2_AssignmentPropertyList_AssignmentPropertyList_AssignmentProperty(context, ["APL", ",", "AP"])
    assert apl.name == "AssignmentPropertyList"
...
def test_parse_AssignmentPropertyList_01(mocker, context):
    ...
    apl = e.parse_AssignmentPropertyList(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(apl, e.P2_AssignmentPropertyList_AssignmentProperty)
    assert apl.AssignmentProperty == "AssignmentProperty"
    assert lexer.pos == 1
    mocks["AssignmentProperty"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentElementList_init(context):
    ael = e.P2_AssignmentElementList(context, ["child"])
...
def test_P2_AssignmentElementList_AssignmentElisionElement_init(context):
    ael = e.P2_AssignmentElementList_AssignmentElisionElement(context, ["child"])
    assert ael.name == "AssignmentElementList"
...
def test_P2_AssignmentElementList_AssignmentElementList_AssignmentElisionElement_init(context):
    ael = e.P2_AssignmentElementList_AssignmentElementList_AssignmentElisionElement(context, ["child", ",", "sibling"])
    assert ael.name == "AssignmentElementList"
...
def test_parse_AssignmentElementList_01(mocker, context):
    ...
    ael = e.parse_AssignmentElementList(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["AssignmentElisionElement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentElisionElement_init(context):
    aee = e.P2_AssignmentElisionElement(context, ["child"])
...
def test_P2_AssignmentElisionElement_Elision_AssignmentElement_init(context):
    aee = e.P2_AssignmentElisionElement_Elision_AssignmentElement(context, ["Elision", "ae"])
    assert aee.name == "AssignmentElisionElement"
...
def test_P2_AssignmentElisionElement_AssignmentElement_init(context):
    aee = e.P2_AssignmentElisionElement_AssignmentElement(context, ["child"])
    assert aee.name == "AssignmentElisionElement"
...
def test_parse_AssignmentElisionElement_01(mocker, context):
    ...
    aee = e.parse_AssignmentElisionElement(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(aee, e.P2_AssignmentElisionElement_AssignmentElement)
    assert aee.AssignmentElement == "AssignmentElement"
    assert lexer.pos == 1
    mocks["AssignmentElement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentProperty_init(context):
    ap = e.P2_AssignmentProperty(context, ["child"])
...
def test_P2_AssignmentProperty_IdentifierReference_init(context):
    ap = e.P2_AssignmentProperty_IdentifierReference(context, ["child"])
    assert ap.name == "AssignmentProperty"
    assert ap.IdentifierReference == "child"


def test_P2_AssignmentProperty_IdentifierReference_Initializer_init(context):
    ap = e.P2_AssignmentProperty_IdentifierReference_Initializer(context, ["child", "init"])
    assert ap.name == "AssignmentProperty"
    assert ap.IdentifierReference == "child"
...
def test_P2_AssignmentProperty_PropertyName_AssignmentElement_init(context):
    ap = e.P2_AssignmentProperty_PropertyName_AssignmentElement(context, ["child", ":", "bob"])
    assert ap.name == "AssignmentProperty"
...
def test_parse_AssignmentProperty_01(mocker, context):
    ...
    ap = e.parse_AssignmentProperty(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(ap, e.P2_AssignmentProperty_IdentifierReference)
    assert ap.IdentifierReference == "IdentifierReference"
    mocks["IdentifierReference"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    assert lexer.pos == 1
...
def test_parse_AssignmentProperty_03(mocker, context):
    ...
    assert lexer.pos == 3
    mocks["PropertyName"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentElement_init(context):
    ae = e.P2_AssignmentElement(context, ["child"])
...
def test_P2_AssignmentElement_DestructuringAssignmentTarget_init(context):
    ae = e.P2_AssignmentElement_DestructuringAssignmentTarget(context, ["child"])
    assert ae.name == "AssignmentElement"
...
def test_P2_AssignmentElement_DestructuringAssignmentTarget_Initializer_init(context):
    ae = e.P2_AssignmentElement_DestructuringAssignmentTarget_Initializer(context, ["child", "init"])
    assert ae.name == "AssignmentElement"
    assert ae.DestructuringAssignmentTarget == "child"
...
def test_parse_AssignmentElement_dat(mocker, context):
    ...
    ae = e.parse_AssignmentElement(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_AssignmentElement_dat_init(mocker, context):
    ...
    assert lexer.pos == 2
    mocks["DestructuringAssignmentTarget"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    mocks["Initializer"].assert_called_with(context, lexer, True, "YieldArg", "AwaitArg")
...
def test_P2_AssignmentRestElement_init(context):
    are = e.P2_AssignmentRestElement(context, ["child"])
...
def test_P2_AssignmentRestElement_DestructuringAssignmentTarget_init(context):
    are = e.P2_AssignmentRestElement_DestructuringAssignmentTarget(context, ["...", "child"])
    assert are.name == "AssignmentRestElement"
...
def test_parse_AssignmentRestElement_01(mocker, context):
    ...
    are = e.parse_AssignmentRestElement(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_DestructuringAssignmentTarget_init(context):
    dat = e.P2_DestructuringAssignmentTarget(context, ["child"])
...
def test_P2_DestructuringAssignmentTarget_LeftHandSideExpression_init(context):
    dat = e.P2_DestructuringAssignmentTarget_LeftHandSideExpression(context, ["child"])
    assert dat.name == "DestructuringAssignmentTarget"
...
def test_parse_DestructuringAssignmentTarget_01(mocker, context):
    ...
    dat = e.parse_DestructuringAssignmentTarget(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["LeftHandSideExpression"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_Expression_init(context):
    exp = e.P2_Expression(context, ["child"])
...
def test_P2_Expression_AssignmentExpression_init(context):
    exp = e.P2_Expression_AssignmentExpression(context, ["AssignmentExpression"])
    assert exp.name == "Expression"
...
def test_P2_Expression_Expression_COMMA_AssignmentExpression_init(context):
    exp = e.P2_Expression_Expression_COMMA_AssignmentExpression(context, ["Expression", ",", "AssignmentExpression"])
    assert exp.name == "Expression"
...
def test_parse_Expression_01(mocker, context):
    ...
    exp = e.parse_Expression(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_Statement_init(context):
    statement = e.P2_Statement(context, ["child"])
...
def test_parse_Statement_BlockStatement(mocker, context, Return):
    ...
    stmt = e.parse_Statement(context, lexer, "YieldArg", "AwaitArg", Return)
    assert isinstance(stmt, e.P2_Statement_BlockStatement)
    assert stmt.BlockStatement == "BlockStatement"
    assert lexer.pos == 1
    mocks["BlockStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", Return)
...
def test_parse_Statement_VariableStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["VariableStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Statement_EmptyStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["EmptyStatement"].assert_called_with(context, lexer)
...
def test_parse_Statement_ExpressionStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["ExpressionStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Statement_IfStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["IfStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", Return)
...
def test_parse_Statement_BreakableStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["BreakableStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", Return)
...
def test_parse_Statement_ContinueStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["ContinueStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Statement_BreakStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["BreakStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Statement_ReturnStatement(mocker, context):
    ...
    stmt = e.parse_Statement(context, lexer, "YieldArg", "AwaitArg", True)
    assert isinstance(stmt, e.P2_Statement_ReturnStatement)
    assert stmt.ReturnStatement == "ReturnStatement"
    assert lexer.pos == 1
    mocks["ReturnStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Statement_WithStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["WithStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", Return)
...
def test_parse_Statement_LabelledStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["LabelledStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", Return)
...
def test_parse_Statement_ThrowStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["ThrowStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_Statement_TryStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["TryStatement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", Return)
...
def test_parse_Statement_DebuggerStatement(mocker, context, Return):
    ...
    assert lexer.pos == 1
    mocks["DebuggerStatement"].assert_called_with(context, lexer)
...
def test_parse_Statement_ReturnStatement_false(mocker, context):
    ...
    stmt = e.parse_Statement(context, lexer, "YieldArg", "AwaitArg", False)
    assert stmt is None
    assert lexer.pos == 0
...
def test_P2_Declaration_init(context):
    decl = e.P2_Declaration(context, ["child"])
...
def test_parse_Declaration_01(mocker, context, token_stream, expected_class, parm_test, parm_name, subcall_args):
    ...
    decl = e.parse_Declaration(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(decl, expected_class)
    assert lexer.pos == 1
    assert parm_test(decl)
    mocks[parm_name].assert_called_with(context, lexer, *subcall_args)
...
def test_P2_HoistableDeclaration_init(context):
    hd = e.P2_HoistableDeclaration(context, ["child"])
...
def test_parse_HoistableDeclaration_01(mocker, context, token_stream, expected_class, prop_name):
    ...
    hd = e.parse_HoistableDeclaration(context, lexer, "YieldArg", "AwaitArg", "DefaultArg")
    assert isinstance(hd, expected_class)
    assert getattr(hd, prop_name) == prop_name
    assert lexer.pos == 1
    mocks[prop_name].assert_called_with(context, lexer, "YieldArg", "AwaitArg", "DefaultArg")
...
def test_P2_BreakableStatement_init(context):
    bs = e.P2_BreakableStatement(context, ["child"])
...
def test_P2_BreakableStatement_IterationStatement_init(context):
    bs = e.P2_BreakableStatement_IterationStatement(context, ["child"])
    assert bs.name == "BreakableStatement"
    assert bs.IterationStatement == "child"


def test_P2_BreakableStatement_SwitchStatement_init(context):
    bs = e.P2_BreakableStatement_SwitchStatement(context, ["child"])
    assert bs.name == "BreakableStatement"
...
def test_parse_BreakableStatement_01(mocker, context, token_stream, expected_class, prop_name):
    ...
    bs = e.parse_BreakableStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    assert isinstance(bs, expected_class)
    assert getattr(bs, prop_name) == prop_name
    assert lexer.pos == 1
    mocks[prop_name].assert_called_with(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
...
def test_P2_BlockStatement_init(context):
    bs = e.P2_BlockStatement(context, ["child"])
...
def test_P2_BlockStatement_Block_init(context):
    bs = e.P2_BlockStatement_Block(context, ["child"])
    assert bs.name == "BlockStatement"
...
def test_parse_BlockStatement_01(mocker, context):
    ...
    bs = e.parse_BlockStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    assert isinstance(bs, e.P2_BlockStatement_Block)
    assert bs.Block == "Block"
    assert lexer.pos == 1
    mocks["Block"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
...
def test_P2_Block_init(context):
    block = e.P2_Block(context, ["child"])
...
def test_P2_Block_Empty_init(context):
    block = e.P2_Block_Empty(context, ["child"])
    assert block.name == "Block"


def test_P2_Block_StatementList_init(context):
    block = e.P2_Block_StatementList(context, ["{", "stmt", "}"])
    assert block.name == "Block"
...
def test_parse_Block_01(mocker, context, token_stream, expected_class, prop_name):
    ...
    block = e.parse_Block(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
...
def test_P2_StatementList_init(context):
    sl = e.P2_StatementList(context, ["child"])
...
def test_P2_StatementList_StatementListItem_init(context):
    sl = e.P2_StatementList_StatementListItem(context, ["child"])
    assert sl.name == "StatementList"
    assert sl.StatementListItem == "child"


def test_P2_StatementList_StatementList_StatementListItem_init(context):
    sl = e.P2_StatementList_StatementList_StatementListItem(context, ["sl", "sli"])
    assert sl.name == "StatementList"
...
def test_parse_StatementList_StatementListItem(mocker, context):
    ...
    sl = e.parse_StatementList(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    assert isinstance(sl, e.P2_StatementList_StatementListItem)
    assert sl.StatementListItem == "StatementListItem"
    assert lexer.pos == 1
    mocks["sli"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
...
def test_P2_StatementListItem_init(context):
    sli = e.P2_StatementListItem(context, ["child"])
...
def test_P2_StatementListItem_Statement_init(context):
    sli = e.P2_StatementListItem_Statement(context, ["child"])
    assert sli.name == "StatementListItem"
    assert sli.Statement == "child"


def test_P2_StatementListItem_Declaration_init(context):
    sli = e.P2_StatementListItem_Declaration(context, ["child"])
    assert sli.name == "StatementListItem"
...
def test_parse_StatementListItem_Statement(mocker, context):
    ...
    sli = e.parse_StatementListItem(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    assert isinstance(sli, e.P2_StatementListItem_Statement)
    assert sli.Statement == "Statement"
    assert lexer.pos == 1
    mocks["stmt"].assert_called_with(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
...
def test_parse_StatementListItem_Declaration(mocker, context):
    ...
    assert lexer.pos == 1
    mocks["decl"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_LexicalDeclaration_init(context):
    ld = e.P2_LexicalDeclaration(context, ["child"])
...
def test_P2_LexicalDeclaration_LetOrConst_BindingList_init(context):
    ld = e.P2_LexicalDeclaration_LetOrConst_BindingList(context, ["const", "bindings", ";"])
    assert ld.name == "LexicalDeclaration"
...
def test_parse_LexicalDeclaration_01(mocker, context):
    ...
    ld = e.parse_LexicalDeclaration(context, lexer, "InArg", "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 3
    mocks["LetOrConst"].assert_called_with(context, lexer)
    mocks["BindingList"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_LetOrConst_init(context):
    loc = e.P2_LetOrConst(context, ["child"])
...
def test_P2_LetOrConst_Let_init(context):
    loc = e.P2_LetOrConst_Let(context, ["child"])
    assert loc.name == "LetOrConst"


def test_P2_LetOrConst_Const_init(context):
    loc = e.P2_LetOrConst_Const(context, ["child"])
    assert loc.name == "LetOrConst"
...
def test_LetOrConst_01(context, token, expected_class):
    ...
    loc = e.parse_LetOrConst(context, lexer)
...
def test_P2_BindingList_init(context):
    bl = e.P2_BindingList(context, ["child"])
...
def test_P2_BindingList_LexicalBinding_init(context):
    bl = e.P2_BindingList_LexicalBinding(context, ["child"])
    assert bl.name == "BindingList"
    assert bl.LexicalBinding == "child"


def test_P2_BindingList_BindingList_LexicalBinding_init(context):
    bl = e.P2_BindingList_BindingList_LexicalBinding(context, ["child", ",", "sibling"])
    assert bl.name == "BindingList"
...
def test_parse_BindingList_01(mocker, context):
    ...
    bl = e.parse_BindingList(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(bl, e.P2_BindingList_LexicalBinding)
    assert lexer.pos == 1
    assert bl.LexicalBinding == "LexicalBinding"
    mocks["LexicalBinding"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_LexicalBinding_init(context):
    lb = e.P2_LexicalBinding(context, ["child"])
...
def test_P2_LexicalBinding_BindingIdentifier_init(context):
    lb = e.P2_LexicalBinding_BindingIdentifier(context, ["child"])
    assert lb.name == "LexicalBinding"
    assert lb.BindingIdentifier == "child"


def test_P2_LexicalBinding_BindingIdentifier_Initializer_init(context):
    lb = e.P2_LexicalBinding_BindingIdentifier_Initializer(context, ["child", "init"])
    assert lb.name == "LexicalBinding"
    assert lb.BindingIdentifier == "child"
...
def test_P2_LexicalBinding_BindingPattern_Initializer_init(context):
    lb = e.P2_LexicalBinding_BindingPattern_Initializer(context, ["child", "init"])
    assert lb.name == "LexicalBinding"
...
def test_parse_LexicalBinding_01(mocker, context, token_stream, expected_class, prop_name, has_init):
    ...
    lb = e.parse_LexicalBinding(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(lb, expected_class)
    assert getattr(lb, prop_name) == prop_name
    assert lexer.pos == len(token_stream)
    mocks[prop_name].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    if has_init:
        assert lb.Initializer == "Initializer"
        mocks["Initializer"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_VariableStatement_init(context):
    vs = e.P2_VariableStatement(context, ["child"])
...
def test_P2_VariableStatement_VariableDeclarationList_init(context):
    vs = e.P2_VariableStatement_VariableDeclarationList(context, ["var", "vdl", ";"])
    assert vs.name == "VariableStatement"
...
def test_parse_VariableStatement_01(mocker, context):
    ...
    vdl = e.parse_VariableStatement(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 3
    mocks["VariableDeclarationList"].assert_called_with(context, lexer, True, "YieldArg", "AwaitArg")
...
def test_P2_VariableDeclarationList_init(context):
    vdl = e.P2_VariableDeclarationList(context, ["child"])
...
def test_P2_VariableDeclarationList_VariableDeclaration_init(context):
    vdl = e.P2_VariableDeclarationList_VariableDeclaration(context, ["child"])
    assert vdl.name == "VariableDeclarationList"
...
def test_P2_VariableDeclarationList_VariableDeclarationList_VariableDeclaration_init(context):
    vdl = e.P2_VariableDeclarationList_VariableDeclarationList_VariableDeclaration(context, ["child", ",", "sibling"])
    assert vdl.name == "VariableDeclarationList"
...
def test_parse_VariableDeclarationList_01(mocker, context):
    ...
    vdl = e.parse_VariableDeclarationList(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert isinstance(vdl, e.P2_VariableDeclarationList_VariableDeclaration)
    assert vdl.VariableDeclaration == "VariableDeclaration"
    assert lexer.pos == 1
    mocks["VariableDeclaration"].assert_called_with(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_P2_VariableDeclaration_init(context):
    vd = e.P2_VariableDeclaration(context, ["child"])
...
def test_P2_VariableDeclaration_BindingIdentifier_init(context):
    vd = e.P2_VariableDeclaration_BindingIdentifier(context, ["child"])
    assert vd.name == "VariableDeclaration"
    assert vd.BindingIdentifier == "child"


def test_P2_VariableDeclaration_BindingIdentifier_Initializer_init(context):
    vd = e.P2_VariableDeclaration_BindingIdentifier_Initializer(context, ["child", "init"])
    assert vd.name == "VariableDeclaration"
    assert vd.BindingIdentifier == "child"
...
def test_P2_VariableDeclaration_BindingPattern_Initializer_init(context):
    vd = e.P2_VariableDeclaration_BindingPattern_Initializer(context, ["child", "init"])
    assert vd.name == "VariableDeclaration"
...
def test_parse_VariableDeclaration_01(mocker, context, token_stream, expected_class, prop_name, has_init):
    ...
    vd = e.parse_VariableDeclaration(context, lexer, "InArg", "YieldArg", "AwaitArg")
...
def test_parse_VariableDeclaration_02(mocker, context, token_stream):
    ...
    lb = e.parse_VariableDeclaration(context, lexer, "InArg", "YieldArg", "AwaitArg")
    assert lb is None
    assert lexer.pos == 0
...
def test_P2_BindingPattern_init(context):
    bp = e.P2_BindingPattern(context, ["child"])
...
def test_P2_BindingPattern_ObjectBindingPattern_init(context):
    bp = e.P2_BindingPattern_ObjectBindingPattern(context, ["child"])
    assert bp.name == "BindingPattern"
    assert bp.ObjectBindingPattern == "child"


def test_P2_BindingPattern_ArrayBindingPattern_init(context):
    bp = e.P2_BindingPattern_ArrayBindingPattern(context, ["child"])
    assert bp.name == "BindingPattern"
...
def test_parse_BindingPattern_01(mocker, context, token, name, expected_class):
    ...
    bp = e.parse_BindingPattern(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(bp, expected_class)
    assert getattr(bp, name) == name
    assert lexer.pos == 1
    mocks[name].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_ObjectBindingPattern_init(context):
    obp = e.P2_ObjectBindingPattern(context, ["child"])
...
def test_P2_ObjectBindingPattern_Empty_init(context):
    obp = e.P2_ObjectBindingPattern_Empty(context, ["child"])
    assert obp.name == "ObjectBindingPattern"


def test_P2_ObjectBindingPattern_BindingRestProperty_init(context):
    obp = e.P2_ObjectBindingPattern_BindingRestProperty(context, ["{", "child", "}"])
    assert obp.name == "ObjectBindingPattern"
    assert obp.BindingRestProperty == "child"


def test_P2_ObjectBindingPattern_BindingPropertyList_init(context):
    obp = e.P2_ObjectBindingPattern_BindingPropertyList(context, ["{", "child", "}"])
    assert obp.name == "ObjectBindingPattern"
...
def test_parse_ObjectBindingPattern_01(
    ...
    obp = e.parse_ObjectBindingPattern(context, lexer, "YieldArg", "AwaitArg")
    ...
    if has_restprop:
        mocks["BindingRestProperty"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    if has_proplist:
        mocks["BindingPropertyList"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    assert lexer.pos == len(token_stream)
...
def test_P2_ArrayBindingPattern_init(context):
    abp = e.P2_ArrayBindingPattern(context, ["child"])
...
def test_P2_ArrayBindingPattern_BindingElementList_init(context):
    abp = e.P2_ArrayBindingPattern_BindingElementList(context, ["[", "child", "]"])
    assert abp.name == "ArrayBindingPattern"
    assert abp.BindingElementList == "child"


def test_P2_ArrayBindingPattern_BindingElementList_Elision_init(context):
    abp = e.P2_ArrayBindingPattern_BindingElementList_Elision(context, ["[", "child", ",", ",,,", "]"])
    assert abp.name == "ArrayBindingPattern"
    assert abp.BindingElementList == "child"
    assert abp.Elision == ",,,"
...
def test_P2_ArrayBindingPattern_BindingElementList_BindingRestElement_init(context):
    abp = e.P2_ArrayBindingPattern_BindingElementList_BindingRestElement(context, ["[", "child", ",", "...bre", "]"])
    assert abp.name == "ArrayBindingPattern"
    assert abp.BindingElementList == "child"
...
def test_parse_ArrayBindingPattern_01(mocker, context, token_stream, expected_class, has_bel, has_elision, has_bre):
    ...
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    elision_mock_check = mock_check("Elision", has_elision)
    bre_mock_check = mock_check("BindingRestElement", has_bre, "YieldArg", "AwaitArg")
    bel_mock_check = mock_check("BindingElementList", has_bel, "YieldArg", "AwaitArg")

    abp = e.parse_ArrayBindingPattern(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_BindingRestProperty_init(context):
    brp = e.P2_BindingRestProperty(context, ["child"])
...
def test_P2_BindingRestProperty_BindingIdentifier_init(context):
    brp = e.P2_BindingRestProperty_BindingIdentifier(context, ["...", "child"])
    assert brp.name == "BindingRestProperty"
...
def test_parse_BindingRestProperty_01(mocker, context):
    ...
    brp = e.parse_BindingRestProperty(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 2
    mocks["BindingIdentifier"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_BindingRestProperty_02(mocker, context, token_stream):
    ...
    mocks = BindingRestProperty_mocks(mocker)
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    brp_check = mock_check("BindingIdentifier", False, "YieldArg", "AwaitArg")
...
def test_P2_BindingPropertyList_init(context):
    bpl = e.P2_BindingPropertyList(context, ["child"])
...
def test_P2_BindingPropertyList_BindingProperty_init(context):
    bpl = e.P2_BindingPropertyList_BindingProperty(context, ["child"])
    assert bpl.name == "BindingPropertyList"
    assert bpl.BindingProperty == "child"


def test_P2_BindingPropertyList_BindingPropertyList_BindingProperty_init(context):
    bpl = e.P2_BindingPropertyList_BindingPropertyList_BindingProperty(context, ["list", ",", "child"])
    assert bpl.name == "BindingPropertyList"
...
def test_parse_BindingPropertyList_01(mocker, context):
    ...
    bpl = e.parse_BindingPropertyList(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(bpl, e.P2_BindingPropertyList_BindingProperty)
    assert bpl.BindingProperty == "BindingProperty"
    assert lexer.pos == 1
    mocks["BindingProperty"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_BindingPropertyList_03(mocker, context, token_stream):
    ...
    mocks = BindingPropertyList_mocks(mocker)
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    bp_check = mock_check("BindingProperty", False, "YieldArg", "AwaitArg")
...
def test_P2_BindingElementList_init(context):
    bel = e.P2_BindingElementList(context, ["child"])
...
def test_P2_BindingElementList_BindingElement_init(context):
    bel = e.P2_BindingElementList_BindingElisionElement(context, ["child"])
    assert bel.name == "BindingElementList"
...
def test_P2_BindingElementList_BindingElementList_BindingElisionElement_init(context):
    bel = e.P2_BindingElementList_BindingElementList_BindingElisionElement(context, ["list", ",", "child"])
    assert bel.name == "BindingElementList"
...
def test_parse_BindingElementList_01(mocker, context):
    ...
    bel = e.parse_BindingElementList(context, lexer, "YieldArg", "AwaitArg")
    ...
    assert lexer.pos == 1
    mocks["BindingElisionElement"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_BindingElementList_03(mocker, context, token_stream):
    ...
    mocks = BindingElementList_mocks(mocker)
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    bee_check = mock_check("BindingElisionElement", False, "YieldArg", "AwaitArg")
...
def test_P2_BindingElisionElement(context):
    bee = e.P2_BindingElisionElement(context, ["child"])
...
def test_P2_BindingElisionElement_BindingElement(context):
    bee = e.P2_BindingElisionElement_BindingElement(context, ["child"])
    assert bee.name == "BindingElisionElement"
    assert bee.BindingElement == "child"


def test_P2_BindingElisionElement_Elision_BindingElement(context):
    bee = e.P2_BindingElisionElement_Elision_BindingElement(context, [",,,", "child"])
    assert bee.name == "BindingElisionElement"
    assert bee.Elision == ",,,"
    assert bee.BindingElement == "child"
...
def test_parse_BindingElisionElement_01(mocker, context, token_stream, expected_class, has_elision):
    ...
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    elision_mock_check = mock_check("Elision", has_elision)
    be_mock_check = mock_check("BindingElement", True, "YieldArg", "AwaitArg")

    bee = e.parse_BindingElisionElement(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_BindingElisionElement_02(mocker, context, token_stream):
    ...
    mocks = BindingElisionElement_mocks(mocker)
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    elision_mock_check = mock_check("Elision", False)
    be_mock_check = mock_check("BindingElement", False, "YieldArg", "AwaitArg")
...
def test_P2_BindingProperty(context):
    bp = e.P2_BindingProperty(context, ["child"])
...
def test_P2_BindingProperty_SingleNameBinding(context):
    bp = e.P2_BindingProperty_SingleNameBinding(context, ["child"])
    assert bp.name == "BindingProperty"
    assert bp.SingleNameBinding == "child"


def test_P2_BindingProperty_PropertyName_BindingElement(context):
    bp = e.P2_BindingProperty_PropertyName_BindingElement(context, ["prop", ":", "child"])
    assert bp.name == "BindingProperty"
...
def test_parse_BindingProperty_01(mocker, context, token_stream, expected_class, has_single):
    ...
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    snb_mock_check = mock_check("SingleNameBinding", has_single, "YieldArg", "AwaitArg")
    pn_mock_check = mock_check("PropertyName", not has_single, "YieldArg", "AwaitArg")
    be_mock_check = mock_check("BindingElement", not has_single, "YieldArg", "AwaitArg")

    bp = e.parse_BindingProperty(context, lexer, "YieldArg", "AwaitArg")
    assert isinstance(bp, expected_class)
...
def test_parse_BindingProperty_02(mocker, context, token_stream):
    ...
    mocks = BindingProperty_mocks(mocker)
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    snb_mock_check = mock_check("SingleNameBinding", False, "YieldArg", "AwaitArg")
    pn_mock_check = mock_check("PropertyName", False, "YieldArg", "AwaitArg")
    be_mock_check = mock_check("BindingElement", False, "YieldArg", "AwaitArg")
...
def test_P2_BindingElement_init(context):
    be = e.P2_BindingElement(context, ["child"])
...
def test_parse_BindingElement_01(mocker, context, token_stream, expected_class, has_single, has_init):
    ...
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    snb_mock_check = mock_check("SingleNameBinding", has_single, "YieldArg", "AwaitArg")
    bp_mock_check = mock_check("BindingPattern", not has_single, "YieldArg", "AwaitArg")
    init_mock_check = mock_check("Initializer", has_init, True, "YieldArg", "AwaitArg")

    be = e.parse_BindingElement(context, lexer, "YieldArg", "AwaitArg")
...
def test_parse_BindingElement_02(mocker, context, token_stream):
    ...
    mock_check = gen_mock_check(mocker, mocks, context, lexer)
    snb_mock_check = mock_check("SingleNameBinding", False, "YieldArg", "AwaitArg")
    bp_mock_check = mock_check("BindingPattern", False, "YieldArg", "AwaitArg")
    init_mock_check = mock_check("Initializer", False, True, "YieldArg", "AwaitArg")
...
class Test_SingleNameBinding:
    def test_P2_SingleNameBinding_init(self, context):
        snb = e.P2_SingleNameBinding(context, ["child"])
    ...
    def test_P2_SingleNameBinding_BindingIdentifier_init(self, context):
        snb = e.P2_SingleNameBinding_BindingIdentifier(context, ["child"])
        assert snb.name == "SingleNameBinding"
        assert snb.BindingIdentifier == "child"

    def test_P2_SingleNameBinding_BindingIdentifier_Initializer_init(self, context):
        snb = e.P2_SingleNameBinding_BindingIdentifier_Initializer(context, ["child", "=3"])
        assert snb.name == "SingleNameBinding"
        assert snb.BindingIdentifier == "child"
    ...
    def test_parse_SingleNameBinding_01(self, mocker, context, token_stream, expected_class, has_init):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        bi_mock_check = mock_check("BindingIdentifier", True, "YieldArg", "AwaitArg")
        init_mock_check = mock_check("Initializer", has_init, True, "YieldArg", "AwaitArg")

        snb = e.parse_SingleNameBinding(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_SingleNameBinding_02(self, mocker, context, token_stream):
        ...
        mocks = self.SingleNameBinding_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        bi_mock_check = mock_check("BindingIdentifier", False, "YieldArg", "AwaitArg")
        init_mock_check = mock_check("Initializer", False, True, "YieldArg", "AwaitArg")
...
class Test_BindingRestElement:
    ...
    def test_P2_BindingRestElement_init(context):
        bre = e.P2_BindingRestElement(context, ["child"])
    ...
    def test_P2_BindingRestElement_BindingIdentifier_init(context):
        bre = e.P2_BindingRestElement_BindingIdentifier(context, ["...", "child"])
        assert bre.name == "BindingRestElement"
        assert bre.BindingIdentifier == "child"

    @staticmethod
    def test_P2_BindingRestElement_BindingPattern_init(context):
        bre = e.P2_BindingRestElement_BindingPattern(context, ["...", "child"])
        assert bre.name == "BindingRestElement"
    ...
    def test_parse_BindingRestElement_01(self, mocker, context, token_stream, expected_class, has_BindingIdentifier):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        bi_mock_check = mock_check("BindingIdentifier", has_BindingIdentifier, "YieldArg", "AwaitArg")
        bp_mock_check = mock_check("BindingPattern", not has_BindingIdentifier, "YieldArg", "AwaitArg")

        bre = e.parse_BindingRestElement(context, lexer, "YieldArg", "AwaitArg")
...
def test_P2_EmptyStatement_init(context):
    es = e.P2_EmptyStatement(context, ["child"])
...
def test_P2_EmptyStatement_SEMICOLON_init(context):
    es = e.P2_EmptyStatement_SEMICOLON(context, ["child"])
    assert es.name == "EmptyStatement"
...
def test_parse_EmptyStatement_SEMICOLON(context):
    ...
    es = e.parse_EmptyStatement(context, lexer)
...
def test_P2_ExpressionStatement_init(context):
    es = e.P2_ExpressionStatement(context, ["child"])
...
def test_P2_ExpressionStatement_Expression_SEMICOLON_init(context):
    es = e.P2_ExpressionStatement_Expression_SEMICOLON(context, ["exp_stmt", ";"])
    assert es.name == "ExpressionStatement"
...
def test_parse_ExpressionStatement_Expression_SEMI(mocker, context):
    ...
    exps = e.parse_ExpressionStatement(context, lexer, "YieldArg", "AwaitArg")
...
class Test_IfStatement:
    def test_P2_IfStatement_init(self, context):
        ifs = e.P2_IfStatement(context, ["child"])
    ...
    def test_P2_IfStatement_Expression_Statement_Statement_init(self, context):
        ifs = e.P2_IfStatement_Expression_Statement_Statement(context, ["child"])
        assert ifs.name == "IfStatement"

    def test_P2_IfStatement_Expression_Statement_init(self, context):
        ifs = e.P2_IfStatement_Expression_Statement(context, ["child"])
        assert ifs.name == "IfStatement"
    ...
    def test_parse_IfStatement_01(self, mocker, context, token_stream, expected_class, has_else):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        exp_mock_check = mock_check("Expression", True, True, "YieldArg", "AwaitArg")
        stmt_mock_check = mock_check("Statement", True, "YieldArg", "AwaitArg", "ReturnArg")

        ifs = e.parse_IfStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_IfStatement_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        exp_mock_check = mock_check("Expression", False, True, "YieldArg", "AwaitArg")
        stmt_mock_check = mock_check("Statement", False, "YieldArg", "AwaitArg", "ReturnArg")
...
class Test_IterationStatement:
    def test_P2_IterationStatement_init(self, context):
        istmt = e.P2_IterationStatement(context, ["child"])
    ...
    def test_P2_IterationStatement_DO_Statement_WHILE_Expression_init(self, context):
        istmt = e.P2_IterationStatement_DO_Statement_WHILE_Expression(
            context, ["do", "Statement", "while", "(", "Expression", ")", ";"]
        )
        assert istmt.name == "IterationStatement"
    ...
    def test_P2_IterationStatement_WHILE_Expression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_WHILE_Expression_Statement(
            context, ["while", "(", "Expression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.Expression == "Expression"
        assert istmt.Statement == "Statement"
    ...
    def test_P2_IterationStatement_FOR_ExpressionInit_ExpressionTest_ExpressionInc_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_ExpressionInit_ExpressionTest_ExpressionInc_Statement(
            context, ["for", "(", "ExpInit", ";", "ExpTest", ";", "ExpInc", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
    ...
    def test_P2_IterationStatement_FOR_LeftHandSideExpression_IN_Expression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_LeftHandSideExpression_IN_Expression_Statement(
            context, ["for", "(", "LeftHandSideExpression", "in", "Expression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
    ...
    def test_P2_IterationStatement_FOR_VAR_ForBinding_IN_Expression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_VAR_ForBinding_IN_Expression_Statement(
            context, ["for", "(", "var", "ForBinding", "in", "Expression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
    ...
    def test_P2_IterationStatement_FOR_ForDeclaration_IN_Expression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_ForDeclaration_IN_Expression_Statement(
            context, ["for", "(", "ForDeclaration", "in", "Expression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
    ...
    def test_P2_IterationStatement_FOR_LeftHandSideExpression_OF_AssignmentExpression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_LeftHandSideExpression_OF_AssignmentExpression_Statement(
            context, ["for", "(", "LeftHandSideExpression", "of", "AssignmentExpression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.LeftHandSideExpression == "LeftHandSideExpression"
    ...
    def test_P2_IterationStatement_FOR_VAR_ForBinding_OF_AssignmentExpression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_VAR_ForBinding_OF_AssignmentExpression_Statement(
            context, ["for", "(", "var", "ForBinding", "of", "AssignmentExpression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.ForBinding == "ForBinding"
        assert istmt.AssignmentExpression == "AssignmentExpression"
    ...
    def test_P2_IterationStatement_FOR_ForDeclaration_OF_AssignmentExpression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_ForDeclaration_OF_AssignmentExpression_Statement(
            context, ["for", "(", "ForDeclaration", "of", "AssignmentExpression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.ForDeclaration == "ForDeclaration"
        assert istmt.AssignmentExpression == "AssignmentExpression"
    ...
    def test_P2_IterationStatement_FOR_AWAIT_LeftHandSideExpression_OF_AssignmentExpression_Statement_init(
        ...
        istmt = e.P2_IterationStatement_FOR_AWAIT_LeftHandSideExpression_OF_AssignmentExpression_Statement(
            context, ["for", "await", "(", "LeftHandSideExpression", "of", "AssignmentExpression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.LeftHandSideExpression == "LeftHandSideExpression"
        assert istmt.AssignmentExpression == "AssignmentExpression"
    ...
    def test_P2_IterationStatement_FOR_AWAIT_VAR_ForBinding_OF_AssignmentExpression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_AWAIT_VAR_ForBinding_OF_AssignmentExpression_Statement(
            context, ["for", "await", "(", "var", "ForBinding", "of", "AssignmentExpression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.ForBinding == "ForBinding"
        assert istmt.AssignmentExpression == "AssignmentExpression"
    ...
    def test_P2_IterationStatement_FOR_AWAIT_ForDeclaration_OF_AssignmentExpression_Statement_init(self, context):
        istmt = e.P2_IterationStatement_FOR_AWAIT_ForDeclaration_OF_AssignmentExpression_Statement(
            context, ["for", "await", "(", "ForDeclaration", "of", "AssignmentExpression", ")", "Statement"]
        )
        assert istmt.name == "IterationStatement"
        assert istmt.ForDeclaration == "ForDeclaration"
        assert istmt.AssignmentExpression == "AssignmentExpression"
    ...
    def test_parse_IterationStatement_01(
        ...
        def alt_exp_check():
            ...
            assert len(calls) > 0
            assert calls[0] == mocker.call(context, lexer, False, "YieldArg", Await)
            for call in calls[1:]:
                assert call == mocker.call(context, lexer, True, "YieldArg", Await)

        must_be_called = lambda tok: tok in token_stream and (Await or not (flags & AWAIT_ONLY))
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("Statement", must_be_called(STATEMENT), "YieldArg", Await, "ReturnArg"),
            mock_check("VariableDeclarationList", must_be_called(VARIABLEDECLARATIONLIST), False, "YieldArg", Await),
            mock_check("LexicalDeclaration", must_be_called(LD_REPLACEMENT), False, "YieldArg", Await),
            mock_check("LeftHandSideExpression", must_be_called(LHS_REPLACEMENT), "YieldArg", Await),
            mock_check("ForBinding", must_be_called(FORBINDING), "YieldArg", Await),
            mock_check("ForDeclaration", must_be_called(FORDECLARATION), "YieldArg", Await),
            mock_check("AssignmentExpression", must_be_called(AE_REPLACEMENT), True, "YieldArg", Await),
            alt_exp_check
            if (flags & ALT_EXPRESSION)
            else mock_check("Expression", must_be_called(EXPRESSION), True, "YieldArg", Await),
        )

        istmt = e.parse_IterationStatement(context, lexer, "YieldArg", Await, "ReturnArg")
    ...
    def test_parse_IterationStatement_02(self, mocker, context, token_stream, Await):
        ...
        def alt_exp_check():
            ...
            calls = mocks["Expression"].call_args_list
            for call in calls:
                assert call == mocker.call(context, lexer, True, "YieldArg", Await) or call == mocker.call(
                    context, lexer, False, "YieldArg", Await
                )

        call_checks = (
            mock_check("Statement", False, "YieldArg", Await, "ReturnArg"),
            mock_check("VariableDeclarationList", False, False, "YieldArg", Await),
            mock_check("LexicalDeclaration", False, False, "YieldArg", Await),
            mock_check("LeftHandSideExpression", False, "YieldArg", Await),
            mock_check("ForBinding", False, "YieldArg", Await),
            mock_check("ForDeclaration", False, "YieldArg", Await),
            mock_check("AssignmentExpression", False, True, "YieldArg", Await),
            alt_exp_check,
        )
...
class Test_ForDeclaration:
    def test_P2_ForDeclaration_init(self, context):
        fd = e.P2_ForDeclaration(context, ["child"])
    ...
    def test_P2_ForDeclaration_LetOrConst_ForBinding_init(self, context):
        fd = e.P2_ForDeclaration_LetOrConst_ForBinding(context, ["loc", "forbinding"])
        assert fd.name == "ForDeclaration"
    ...
    def test_parse_ForDeclaration_01(self, mocker, context):
        ...
        fd = e.parse_ForDeclaration(context, lexer, "YieldArg", "AwaitArg")
        assert isinstance(fd, e.P2_ForDeclaration_LetOrConst_ForBinding)
        assert fd.LetOrConst == "LetOrConst"
        assert fd.ForBinding == "ForBinding"
        assert lexer.pos == 2
        mocks["LetOrConst"].assert_called_with(context, lexer)
        mocks["ForBinding"].assert_called_with(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_ForDeclaration_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("LetOrConst", False), mock_check("ForBinding", False, "YieldArg", "AwaitArg"))
...
class Test_ForBinding:
    def test_P2_ForBinding_init(self, context):
        fb = e.P2_ForBinding(context, ["child"])
    ...
    def test_P2_ForBinding_BindingIdentifier_init(self, context):
        fb = e.P2_ForBinding_BindingIdentifier(context, ["child"])
        assert fb.name == "ForBinding"
        assert fb.BindingIdentifier == "child"

    def test_P2_ForBinding_BindingPattern_init(self, context):
        fb = e.P2_ForBinding_BindingPattern(context, ["child"])
        assert fb.name == "ForBinding"
    ...
    def test_parse_ForBinding_01(self, mocker, context, token_stream, expected_class, production_check):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("BindingIdentifier", BINDINGIDENTIFIER in token_stream, "YieldArg", "AwaitArg"),
            mock_check("BindingPattern", BINDINGPATTERN in token_stream, "YieldArg", "AwaitArg"),
        )

        fb = e.parse_ForBinding(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_ForBinding_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("BindingIdentifier", False, "YieldArg", "AwaitArg"),
            mock_check("BindingPattern", False, "YieldArg", "AwaitArg"),
        )
...
class Test_ContinueStatement:
    def test_P2_ContinueStatement_init(self, context):
        cs = e.P2_ContinueStatement(context, ["child"])
    ...
    def test_P2_ContinueStatement_CONTINUE_init(self, context):
        cs = e.P2_ContinueStatement_CONTINUE(context, ["continue", ";"])
        assert cs.name == "ContinueStatement"

    def test_P2_ContinueStatement_CONTINUE_LabelIdentifier_init(self, context):
        cs = e.P2_ContinueStatement_CONTINUE_LabelIdentifier(context, ["continue", "superduper", ";"])
        assert cs.name == "ContinueStatement"
    ...
    def test_parse_ContinueStatement_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("LabelIdentifier", must_be_called(LABELIDENTIFIER_NONL), "YieldArg", "AwaitArg"),)

        cs = e.parse_ContinueStatement(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_ContinueStatement_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("LabelIdentifier", False, "YieldArg", "AwaitArg"),)
        cs = e.parse_ContinueStatement(context, lexer, "YieldArg", "AwaitArg")
        assert cs is None
        assert lexer.pos == 0
        for check in call_checks:
...
class Test_BreakStatement:
    ...
    def test_parse_BreakStatement_01(
        ...
        cs = e.parse_BreakStatement(context, lexer, "YieldArg", "AwaitArg")
        assert isinstance(cs, expected_class)
        for key in production_checks:
            assert getattr(cs, key) == key, f"assert cs.{key} == {key!r}"
        for idx, expected in token_checks:
...
class Test_ReturnStatement:
    def test_P2_ReturnStatement_init(self, context):
        rs = e.P2_ReturnStatement(context, ["child"])
    ...
    def test_P2_ReturnStatement_RETURN_init(self, context):
        rs = e.P2_ReturnStatement_RETURN(context, ["return", ";"])
        assert rs.name == "ReturnStatement"

    def test_P2_ReturnStatement_RETURN_Expression_init(self, context):
        rs = e.P2_ReturnStatement_RETURN_Expression(context, ["return", "Expression", ";"])
        assert rs.name == "ReturnStatement"
    ...
    def test_parse_ReturnStatement_01(
        ...
        must_be_called = lambda tok: tok in token_stream
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("Expression", must_be_called(EXPRESSION_NONL), True, "YieldArg", "AwaitArg"),)

        rs = e.parse_ReturnStatement(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_ReturnStatement_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("Expression", False, True, "YieldArg", "AwaitArg"),)
        rs = e.parse_ReturnStatement(context, lexer, "YieldArg", "AwaitArg")
        assert rs is None
        assert lexer.pos == 0
        for check in call_checks:
...
class Test_WithStatement:
    def test_P2_WithStatement_init(self, context):
        ws = e.P2_WithStatement(context, ["child"])
    ...
    def test_P2_WithStatement_WITH_Expression_Statement_init(self, context):
        ws = e.P2_WithStatement_WITH_Expression_Statement(context, ["with", "(", "Expression", ")", "Statement"])
        assert ws.name == "WithStatement"
    ...
    def test_parse_WithStatement_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("Expression", True, True, "YieldArg", "AwaitArg"),
            mock_check("Statement", True, "YieldArg", "AwaitArg", "ReturnArg"),
        )

        ws = e.parse_WithStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_WithStatement_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("Expression", False, True, "YieldArg", "AwaitArg"),
            mock_check("Statement", False, "YieldArg", "AwaitArg", "ReturnArg"),
        )
        ws = e.parse_WithStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
        assert ws is None
        assert lexer.pos == 0
...
class Test_SwitchStatement:
    def test_P2_SwitchStatement_init(self, context):
        ss = e.P2_SwitchStatement(context, ["child"])
    ...
    def test_P2_SwitchStatement_SWITCH_Expression_CaseBlock_init(self, context):
        ss = e.P2_SwitchStatement_SWITCH_Expression_CaseBlock(context, ["switch", "(", "Expression", ")", "CaseBlock"])
        assert ss.name == "SwitchStatement"
    ...
    def test_parse_SwitchStatement_01(
        ...
        call_checks = (
            mock_check("Expression", True, True, "YieldArg", "AwaitArg"),
            mock_check("CaseBlock", True, "YieldArg", "AwaitArg", "ReturnArg"),
        )

        ss = e.parse_SwitchStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_SwitchStatement_02(self, mocker, context, token_stream):
        ...
        call_checks = (
            mock_check("Expression", False, True, "YieldArg", "AwaitArg"),
            mock_check("CaseBlock", False, "YieldArg", "AwaitArg", "ReturnArg"),
        )
        ss = e.parse_SwitchStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
        assert ss is None
        assert lexer.pos == 0
...
class Test_CaseBlock:
    ...
    def test_P2_CaseBlock_DefaultClause_init(self, context):
        cb = e.P2_CaseBlock_DefaultClause(context, ["{", "default", "}"])
        assert cb.name == "CaseBlock"
    ...
    def test_P2_CaseBlock_CaseClauses_init(self, context):
        cb = e.P2_CaseBlock_CaseClauses(context, ["{", "caseclauses", "}"])
        assert cb.name == "CaseBlock"
        assert cb.DefaultClause is None
    ...
    def test_P2_CaseBlock_CaseClauses_DefaultClause_init(self, context):
        cb = e.P2_CaseBlock_CaseClauses_DefaultClause(context, ["{", "caseclauses", "default", "}"])
        assert cb.name == "CaseBlock"
        assert cb.CaseClausesBefore == "caseclauses"
        assert cb.DefaultClause == "default"
        assert cb.CaseClausesAfter is None
    ...
    def test_P2_CaseBlock_DefaultClause_CaseClauses_init(self, context):
        cb = e.P2_CaseBlock_DefaultClause_CaseClauses(context, ["{", "default", "caseclauses", "}"])
        assert cb.name == "CaseBlock"
        assert cb.CaseClausesBefore is None
        assert cb.DefaultClause == "default"
    ...
    def test_P2_CaseBlock_CaseClauses_DefaultClause_CaseClauses_init(self, context):
        cb = e.P2_CaseBlock_CaseClauses_DefaultClause_CaseClauses(context, ["{", "before", "default", "after", "}"])
        assert cb.name == "CaseBlock"
    ...
    def test_parse_CaseBlock_01(self, mocker, context, token_stream, expected_class, token_checks, production_checks):
        ...
        call_checks = (
            mock_check("CaseClauses", is_present(CASECLAUSES), "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("DefaultClause", is_present(DEFAULTCLAUSE), "YieldArg", "AwaitArg", "ReturnArg"),
        )

        cb = e.parse_CaseBlock(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_CaseBlock_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("CaseClauses", False, "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("DefaultClause", False, "YieldArg", "AwaitArg", "ReturnArg"),
        )
...
class Test_CaseClauses:
    def test_P2_CaseClauses_init(self, context):
        cc = e.P2_CaseClauses(context, ["child"])
    ...
    def test_P2_CaseClauses_CaseClause_init(self, context):
        cc = e.P2_CaseClauses_CaseClause(context, ["caseclause"])
        assert cc.name == "CaseClauses"
        assert cc.CaseClause == "caseclause"

    def test_P2_CaseClauses_CaseClauses_CaseClause_init(self, context):
        cc = e.P2_CaseClauses_CaseClauses_CaseClause(context, ["clauses", "clause"])
        assert cc.name == "CaseClauses"
    ...
    def test_parse_CaseClauses_01(self, mocker, context, token_stream, expected_class, token_checks, production_checks):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("CaseClause", is_present(CASECLAUSE), "YieldArg", "AwaitArg", "ReturnArg"),)

        cc = e.parse_CaseClauses(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_CaseClauses_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("CaseClause", False, "YieldArg", "AwaitArg", "ReturnArg"),)
...
class Test_CaseClause:
    ...
    def test_parse_CaseClause_01(self, mocker, context, token_stream, expected_class, token_checks, production_checks):
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("Expression", is_present(EXPRESSION), True, "YieldArg", "AwaitArg"),
            mock_check("StatementList", is_present(STATEMENTLIST), "YieldArg", "AwaitArg", "ReturnArg"),
        )

        cc = e.parse_CaseClause(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
        assert isinstance(cc, expected_class)
        for key in production_checks:
    ...
    def test_parse_CaseClause_02(self, mocker, context, token_stream):
        ...
        call_checks = (
            mock_check("Expression", False, True, "YieldArg", "AwaitArg"),
            mock_check("StatementList", False, "YieldArg", "AwaitArg", "ReturnArg"),
        )
...
class Test_DefaultClause:
    def test_P2_DefaultClause_init(self, context):
        dc = e.P2_DefaultClause(context, ["child"])
    ...
    def test_P2_DefaultClause_DEFAULT_init(self, context):
        dc = e.P2_DefaultClause_DEFAULT(context, ["default", ":"])
        assert dc.name == "DefaultClause"
        assert dc.StatementList is None

    def test_P2_DefaultClause_DEFAULT_StatementList_init(self, context):
        dc = e.P2_DefaultClause_DEFAULT_StatementList(context, ["default", ":", "Stmts"])
        assert dc.name == "DefaultClause"
    ...
    def test_parse_DefaultClause_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("StatementList", is_present(STATEMENTLIST), "YieldArg", "AwaitArg", "ReturnArg"),)

        dc = e.parse_DefaultClause(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_DefaultClause_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("StatementList", False, "YieldArg", "AwaitArg", "ReturnArg"),)
...
class Test_LabelledStatement:
    def test_P2_LabelledStatement_init(self, context):
        ls = e.P2_LabelledStatement(context, ["child"])
    ...
    def test_P2_LabelledStatement_LabelIdentifier_LabelledItem_init(self, context):
        ls = e.P2_LabelledStatement_LabelIdentifier_LabelledItem(context, ["id", ":", "item"])
        assert ls.name == "LabelledStatement"
    ...
    def test_parse_LabelledStatement_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("LabelIdentifier", is_present(LABELIDENTIFIER), "YieldArg", "AwaitArg"),
            mock_check("LabelledItem", is_present(LABELLEDITEM), "YieldArg", "AwaitArg", "ReturnArg"),
        )

        ls = e.parse_LabelledStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_LabelledStatement_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("LabelIdentifier", False, "YieldArg", "AwaitArg"),
            mock_check("LabelledItem", False, "YieldArg", "AwaitArg", "ReturnArg"),
        )
...
class Test_LabelledItem:
    def test_P2_LabelledItem_init(self, context):
        li = e.P2_LabelledItem(context, ["child"])
    ...
    def test_P2_LabelledItem_Statement_init(self, context):
        li = e.P2_LabelledItem_Statement(context, ["child"])
        assert li.name == "LabelledItem"
        assert li.Statement == "child"

    def test_P2_LabelledItem_FunctionDeclaration_init(self, context):
        li = e.P2_LabelledItem_FunctionDeclaration(context, ["child"])
        assert li.name == "LabelledItem"
    ...
    def test_parse_LabelledItem_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("Statement", is_present(STATEMENT), "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("FunctionDeclaration", is_present(FUNCTIONDECLARATION), "YieldArg", "AwaitArg", False),
        )

        li = e.parse_LabelledItem(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_LabelledItem_02(self, mocker, context, token_stream):
        ...
        call_checks = (
            mock_check("Statement", False, "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("FunctionDeclaration", False, "YieldArg", "AwaitArg", False),
        )
...
class Test_ThrowStatement:
    def P2_ThrowStatement_init(self, context):
        ts = e.P2_ThrowStatement(context, ["child"])
    ...
    def P2_ThrowStatement_THROW_Expression_init(self, context):
        ts = e.P2_ThrowStatement_THROW_Expression(context, ["throw", "exp", ";"])
        assert ts.name == "ThrowStatement"
    ...
    def test_parse_ThrowStatement_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("Expression", is_present(EXPRESSION_NONL), True, "YieldArg", "AwaitArg"),)

        ts = e.parse_ThrowStatement(context, lexer, "YieldArg", "AwaitArg")
...
class Test_TryStatement:
    def test_P2_TryStatement_init(self, context):
        ts = e.P2_TryStatement(context, ["child"])
        assert ts.name == "TryStatement"
        assert ts.context == context
        assert ts.children == ["child"]

    def test_P2_TryStatement_TRY_Block_Catch_init(self, context):
        ts = e.P2_TryStatement_TRY_Block_Catch(context, ["try", "block", "catch"])
        assert ts.name == "TryStatement"
    ...
    def test_P2_TryStatement_TRY_Block_Finally_init(self, context):
        ts = e.P2_TryStatement_TRY_Block_Finally(context, ["try", "block", "finally"])
        assert ts.name == "TryStatement"
        assert ts.Block == "block"
    ...
    def test_P2_TryStatement_TRY_Block_Catch_Finally_init(self, context):
        ts = e.P2_TryStatement_TRY_Block_Catch_Finally(context, ["try", "block", "catch", "finally"])
        assert ts.name == "TryStatement"
        assert ts.Block == "block"
        assert ts.Catch == "catch"
        assert ts.Finally == "finally"
    ...
    def test_parse_TryStatement_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("Block", is_present(BLOCK), "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("Catch", is_present(CATCH_PRODUCTION), "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("Finally", is_present(FINALLY_PRODUCTION), "YieldArg", "AwaitArg", "ReturnArg"),
        )

        ts = e.parse_TryStatement(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
        assert isinstance(ts, expected_class)
        for key in production_checks:
            assert getattr(ts, key) == key, f"assert ts.{key} == {key!r}"
        for idx, expected in token_checks:
    ...
    def test_parse_TryStatement_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("Block", False, "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("Catch", False, "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("Finally", False, "YieldArg", "AwaitArg", "ReturnArg"),
        )
...
class Test_Catch:
    ...
    def test_P2_Catch_CATCH_CatchParameter_Block_init(self, context):
        cat = e.P2_Catch_CATCH_CatchParameter_Block(context, ["catch", "(", "param", ")", "block"])
        assert cat.name == "Catch"
        assert cat.CatchParameter == "param"
        assert cat.Block == "block"

    def test_P2_Catch_CATCH_Block_init(self, context):
        cat = e.P2_Catch_CATCH_Block(context, ["catch", "block"])
        assert cat.name == "Catch"
        assert cat.Block == "block"
    ...
    def test_parse_Catch_01(self, mocker, context, token_stream, expected_class, token_checks, production_checks):
        ...
        call_checks = (
            mock_check("Block", is_present(BLOCK), "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("CatchParameter", is_present(CATCHPARAMETER), "YieldArg", "AwaitArg"),
        )

        cat = e.parse_Catch(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_Catch_02(self, mocker, context, token_stream):
        ...
        call_checks = (
            mock_check("Block", False, "YieldArg", "AwaitArg", "ReturnArg"),
            mock_check("CatchParameter", False, "YieldArg", "AwaitArg"),
        )
...
class Test_Finally:
    def test_P2_Finally_init(self, context):
        fin = e.P2_Finally(context, ["child"])
    ...
    def test_P2_Finally_FINALLY_Block_init(self, context):
        fin = e.P2_Finally_FINALLY_Block(context, ["finally", "block"])
        assert fin.name == "Finally"
    ...
    def test_parse_Finally_01(self, mocker, context, token_stream, expected_class, token_checks, production_checks):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("Block", is_present(BLOCK), "YieldArg", "AwaitArg", "ReturnArg"),)

        fin = e.parse_Finally(context, lexer, "YieldArg", "AwaitArg", "ReturnArg")
    ...
    def test_parse_Finally_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("Block", False, "YieldArg", "AwaitArg", "ReturnArg"),)
...
class Test_CatchParameter:
    def test_P2_CatchParameter_init(self, context):
        cp = e.P2_CatchParameter(context, ["child"])
    ...
    def test_P2_CatchParameter_BindingIdentifier_init(self, context):
        cp = e.P2_CatchParameter_BindingIdentifier(context, ["child"])
        assert cp.name == "CatchParameter"
        assert cp.BindingIdentifier == "child"

    def test_P2_CatchParameter_BindingPattern_init(self, context):
        cp = e.P2_CatchParameter_BindingPattern(context, ["child"])
        assert cp.name == "CatchParameter"
    ...
    def test_parse_CatchParameter_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("BindingIdentifier", is_present(BINDINGIDENTIFIER), "YieldArg", "AwaitArg"),
            mock_check("BindingPattern", is_present(BINDINGPATTERN), "YieldArg", "AwaitArg"),
        )

        cp = e.parse_CatchParameter(context, lexer, "YieldArg", "AwaitArg")
...
class Test_DebuggerStatement:
    def test_P2_DebuggerStatement_init(self, context):
        ds = e.P2_DebuggerStatement(context, ["child"])
    ...
    def test_P2_DebuggerStatement_DEBUGGER_init(self, context):
        ds = e.P2_DebuggerStatement_DEBUGGER(context, ["child"])
        assert ds.name == "DebuggerStatement"
    ...
    def test_parse_DebuggerStatement_01(
        ...
        ds = e.parse_DebuggerStatement(context, lexer)
...
class Test_FunctionDeclaration:
    def test_P2_FunctionDeclaration_init(self, context):
        fd = e.P2_FunctionDeclaration(context, ["child"])
    ...
    def test_P2_FunctionDeclaration_FUNCTION_BindingIdentifier_FormalParameters_FunctionBody_init(self, context):
        fd = e.P2_FunctionDeclaration_FUNCTION_BindingIdentifier_FormalParameters_FunctionBody(
            context, ["function", "BindingIdentifier", "(", "FormalParameters", ")", "{", "FunctionBody", "}"]
        )
        assert fd.name == "FunctionDeclaration"
    ...
    def test_P2_FunctionDeclaration_FUNCTION_FormalParameters_FunctionBody_init(self, context):
        fd = e.P2_FunctionDeclaration_FUNCTION_FormalParameters_FunctionBody(
            context, ["function", "(", "FormalParameters", ")", "{", "FunctionBody", "}"]
        )
        assert fd.name == "FunctionDeclaration"
        assert fd.FormalParameters == "FormalParameters"
        assert fd.FunctionBody == "FunctionBody"
    ...
    def test_parse_FunctionDeclaration_01(
        ...
        call_checks = (
            mock_check("BindingIdentifier", is_present(BINDINGIDENTIFIER), "YieldArg", "AwaitArg"),
            mock_check("FormalParameters", is_present(FORMALPARAMETERS), False, False),
            mock_check("FunctionBody", is_present(FUNCTIONBODY), False, False),
        )

        fd = e.parse_FunctionDeclaration(context, lexer, "YieldArg", "AwaitArg", Default)
    ...
    def test_parse_FunctionDeclaration_DefaultTrue(self, mocker, context, token_stream):
        ...
        call_checks = (
            mock_check("BindingIdentifier", False, "YieldArg", "AwaitArg"),
            mock_check("FormalParameters", False, False, False),
            mock_check("FunctionBody", False, False, False),
        )

        fd = e.parse_FunctionDeclaration(context, lexer, "YieldArg", "AwaitArg", True)
        assert fd is None
        assert lexer.pos == 0
        for check in call_checks:
            check()
    ...
    def test_parse_FunctionDeclaration_DefaultFalse(self, mocker, context, token_stream):
        ...
        fd = e.parse_FunctionDeclaration(context, lexer, "YieldArg", "AwaitArg", False)
        assert fd is None
        assert lexer.pos == 0
        for check in call_checks:
            check()
...
class Test_FunctionExpression:
    def test_P2_FunctionExpression_init(self, context):
        fe = e.P2_FunctionExpression(context, ["child"])
    ...
    def test_parse_FunctionExpression_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("BindingIdentifier", is_present(BINDINGIDENTIFIER), False, False),
            mock_check("FormalParameters", is_present(FORMALPARAMETERS), False, False),
            mock_check("FunctionBody", is_present(FUNCTIONBODY), False, False),
        )

        fe = e.parse_FunctionExpression(context, lexer)
    ...
    def test_parse_FunctionExpression_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("BindingIdentifier", False, False, False),
            mock_check("FormalParameters", False, False, False),
            mock_check("FunctionBody", False, False, False),
        )
...
class Test_UniqueFormalParameters:
    def test_P2_UniqueFormalParameters_init(self, context):
        ufp = e.P2_UniqueFormalParameters(context, ["child"])
    ...
    def test_P2_UniqueFormalParameters_FormalParameters_init(self, context):
        ufp = e.P2_UniqueFormalParameters_FormalParameters(context, ["child"])
        assert ufp.name == "UniqueFormalParameters"
    ...
    def test_parse_UniqueFormalParameters_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("FormalParameters", is_present(FORMALPARAMETERS), "YieldArg", "AwaitArg"),)

        ufp = e.parse_UniqueFormalParameters(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_UniqueFormalParameters_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("FormalParameters", False, "YieldArg", "AwaitArg"),)
...
class Test_FormalParameters:
    def test_P2_FormalParameters_init(self, context):
        fp = e.P2_FormalParameters(context, ["child"])
    ...
    def test_P2_FormalParameters_EMPTY_init(self, context):
        fp = e.P2_FormalParameters_EMPTY(context, ["child"])
        assert fp.name == "FormalParameters"
    ...
    def test_P2_FormalParameters_FunctionRestParameter_init(self, context):
        fp = e.P2_FormalParameters_FunctionRestParameter(context, ["child"])
        assert fp.name == "FormalParameters"
        assert fp.FormalParameterList is None
        assert fp.FunctionRestParameter == "child"

    def test_P2_FormalParameters_FormalParameterList_init(self, context):
        fp = e.P2_FormalParameters_FormalParameterList(context, ["child"])
        assert fp.name == "FormalParameters"
    ...
    def test_P2_FormalParameters_FormalParameterList_FunctionRestParameter_init(self, context):
        fp = e.P2_FormalParameters_FormalParameterList_FunctionRestParameter(
            context, ["FormalParameterList", ",", "FunctionRestParameter"]
        )
        assert fp.name == "FormalParameters"
    ...
    def test_parse_FormalParameters_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("FormalParameterList", is_present(FORMALPARAMETERLIST), "YieldArg", "AwaitArg"),
            mock_check("FunctionRestParameter", is_present(FUNCTIONRESTPARAMETER), "YieldArg", "AwaitArg"),
        )

        fpl = e.parse_FormalParameters(context, lexer, "YieldArg", "AwaitArg")
...
class Test_FormalParameterList:
    def test_P2_FormalParameterList_init(self, context):
        fpl = e.P2_FormalParameterList(context, ["child"])
    ...
    def test_P2_FormalParameterList_FormalParameter_init(self, context):
        fpl = e.P2_FormalParameterList_FormalParameter(context, ["child"])
        assert fpl.name == "FormalParameterList"
    ...
    def test_P2_FormalParameterList_FormalParameterList_FormalParameter_init(self, context):
        fpl = e.P2_FormalParameterList_FormalParameterList_FormalParameter(
            context, ["FormalParameterList", ",", "FormalParameter"]
        )
        assert fpl.name == "FormalParameterList"
    ...
    def test_parse_FormalParameterList_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("FormalParameter", is_present(FORMALPARAMETER), "YieldArg", "AwaitArg"),)

        fpl = e.parse_FormalParameterList(context, lexer, "YieldArg", "AwaitArg")
        assert isinstance(fpl, expected_class)
        for key, value in production_checks:
            if type(value) == type:
    ...
    def test_parse_FormalParameterList_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("FormalParameter", False, "YieldArg", "AwaitArg"),)
...
class Test_FunctionRestParameter:
    def test_P2_FunctionRestParameter_init(self, context):
        frp = e.P2_FunctionRestParameter(context, ["child"])
    ...
    def test_P2_FunctionRestParameter_BindingRestElement_init(self, context):
        frp = e.P2_FunctionRestParameter_BindingRestElement(context, ["child"])
        assert frp.name == "FunctionRestParameter"
    ...
    def test_parse_FunctionRestParameter_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("BindingRestElement", is_present(BINDINGRESTELEMENT), "YieldArg", "AwaitArg"),)

        frp = e.parse_FunctionRestParameter(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_FunctionRestParameter_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("BindingRestElement", False, "YieldArg", "AwaitArg"),)
...
class Test_FormalParameter:
    ...
    def test_parse_FormalParameter_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("BindingElement", is_present(BINDINGELEMENT), "YieldArg", "AwaitArg"),)

        fp = e.parse_FormalParameter(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_FormalParameter_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("BindingElement", False, "YieldArg", "AwaitArg"),)
...
class Test_FunctionBody:
    ...
    def test_parse_FunctionBody_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("FunctionStatementList", is_present(FUNCTIONSTATEMENTLIST), "YieldArg", "AwaitArg"),)

        fb = e.parse_FunctionBody(context, lexer, "YieldArg", "AwaitArg")
        assert isinstance(fb, expected_class)
        for key in production_checks:
    ...
    def test_parse_FunctionBody_02(self, mocker, context, token_stream):
        ...
        mocks = self.setup_mocks(mocker)
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (mock_check("FunctionStatementList", False, "YieldArg", "AwaitArg"),)
...
class Test_FunctionStatementList:
    def test_P2_FunctionStatementList_init(self, context):
        fsl = e.P2_FunctionStatementList(context, ["child"])
    ...
    def test_P2_FunctionStatementList_StatementList_init(self, context):
        fsl = e.P2_FunctionStatementList_StatementList(context, ["child"])
        assert fsl.name == "FunctionStatementList"
        assert fsl.StatementList == "child"

    def test_P2_FunctionStatementList_EMPTY_init(self, context):
        fsl = e.P2_FunctionStatementList_EMPTY(context, ["child"])
        assert fsl.name == "FunctionStatementList"
    ...
    def test_parse_FunctionStatementList_01(
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        is_present = lambda tok: tok in token_stream
        call_checks = (mock_check("StatementList", is_present(STATEMENTLIST), "YieldArg", "AwaitArg", True),)

        fsl = e.parse_FunctionStatementList(context, lexer, "YieldArg", "AwaitArg")
...
class Test_ArrowFunction:
    def test_P2_ArrowFunction_init(self, context):
        af = e.P2_ArrowFunction(context, ["child"])
    ...
    def test_P2_ArrowFunction_ArrowParameters_ConciseBody_init(self, context):
        af = e.P2_ArrowFunction_ArrowParameters_ConciseBody(context, ["arrowparameters", "=>", "concisebody"])
        assert af.name == "ArrowFunction"
    ...
    def test_parse_ArrowFunction_01(
        ...
        is_present = lambda tok: tok in token_stream
        call_checks = (
            mock_check("ArrowParameters", is_present(ARROWPARAMETERS), "YieldArg", "AwaitArg"),
            mock_check("ConciseBody", is_present(CONCISEBODY), "InArg"),
        )

        af = e.parse_ArrowFunction(context, lexer, "InArg", "YieldArg", "AwaitArg")
    ...
    def test_parse_ArrowFunction_02(self, mocker, context, token_stream):
        ...
        mock_check = gen_mock_check(mocker, mocks, context, lexer)
        call_checks = (
            mock_check("ArrowParameters", False, "YieldArg", "AwaitArg"),
            mock_check("ConciseBody", False, "InArg"),
        )
...
class Test_ArrowParameters:
    ...
    def test_P2_ArrowParameters_CoverParenthesizedExpressionAndArrowParameterList_init(self, context):
        ap = e.P2_ArrowParameters_CoverParenthesizedExpressionAndArrowParameterList(context, ["child"])
        assert ap.name == "ArrowParameters"
    ...
    def test_parse_ArrowParameters_01(
        ...
        ap = e.parse_ArrowParameters(context, lexer, "YieldArg", "AwaitArg")
    ...
    def test_parse_ArrowParameters_02(self, mocker, context, token_stream):
        ...
        call_checks = (
            mock_check("BindingIdentifier", False, "YieldArg", "AwaitArg"),
            mock_check("CoverParenthesizedExpressionAndArrowParameterList", False, "YieldArg", "AwaitArg"),
        )
...
def test_P2_Script_init(context):
    script = e.P2_Script(context, ["child"])
...
def test_P2_Script_Empty_init(context):
    script = e.P2_Script_Empty(context, ["child"])
    assert script.name == "Script"
    assert script.ScriptBody is None


def test_P2_Script_ScriptBody_init(context):
    script = e.P2_Script_ScriptBody(context, ["child"])
    assert script.name == "Script"
...
def test_parse_Script_empty(mocker, context):
    ...
    script = e.parse_Script(context, lexer)
...
def test_parse_Script_ScriptBody(mocker, context):
    ...
    assert lexer.pos == 1
    mocks["ScriptBody"].assert_called_with(context, lexer)
...
def test_P2_ScriptBody_init(context):
    sb = e.P2_ScriptBody(context, ["child"])
...
def test_P2_ScriptBody_StatementList_init(context):
    sb = e.P2_ScriptBody_StatementList(context, ["child"])
    assert sb.name == "ScriptBody"
...
def test_parse_ScriptBody_StatementList(mocker, context):
    ...
    sb = e.parse_ScriptBody(context, lexer)
    assert isinstance(sb, e.P2_ScriptBody_StatementList)
    assert sb.StatementList == "StatementList"
    assert lexer.pos == 1
    mocks["StatementList"].assert_called_with(context, lexer, False, False, False)
